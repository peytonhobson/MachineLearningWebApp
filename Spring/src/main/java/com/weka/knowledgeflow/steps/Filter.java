...
import com.weka.filters.StreamableFilter;
...
public class Filter extends WekaAlgorithmWrapper {
  ...
  /** Template filter */
  protected com.weka.filters.Filter m_filterTemplate;

  /** Used when processing streaming data */
  protected com.weka.filters.Filter m_streamingFilter;
  ...
  protected Map<Integer, com.weka.filters.Filter> m_filterMap =
    new HashMap<Integer, com.weka.filters.Filter>();
  ...
  public Class getWrappedAlgorithmClass() {
    return com.weka.filters.Filter.class;
  }
  ...
  public void setWrappedAlgorithm(Object algo) {
    ...
    String iconp = algo.getClass().getCanonicalName().replace("com.weka.","") + ".gif";
  ...
  public void setFilter(com.weka.filters.Filter filter) {
   ...
   * @return the filter
   */
  public com.weka.filters.Filter getFilter() {
    return (com.weka.filters.Filter) getWrappedAlgorithm();
  }
  ...
  public void stepInit() throws WekaException {
    if (!(getWrappedAlgorithm() instanceof com.weka.filters.Filter)) {
      throw new WekaException("Incorrect type of algorithm");
    }

    try {
      m_filterTemplate = com.weka.filters.Filter.makeCopy(getFilter());
  ...
  public void processIncoming(Data data) throws WekaException {
    ...
    if (m_isReset) {
      ...
      if (data.getConnectionName().equals(StepManager.CON_INSTANCE)) {
        ...
        try {
          m_streamingFilter = com.weka.filters.Filter.makeCopy(m_filterTemplate);
  ...
  protected void processFirstBatch(Instances batch, String conType,
    ...
    try {
      com.weka.filters.Filter filterToUse =
        com.weka.filters.Filter.makeCopy(m_filterTemplate);
      if (!isStopRequested()) {
  ...
  protected synchronized void processSubsequentBatch(Instances batch,
    ...
    com.weka.filters.Filter filterToUse = m_filterMap.get(sN);
    if (filterToUse == null) {
  ...
  protected void processBatch(Instances batch, String conType,
                              com.weka.filters.Filter filterToUse, Integer setNum, Integer maxSetNum)
    throws WekaException {
    try {
      Instances filtered = com.weka.filters.Filter.useFilter(batch, filterToUse);
  ...
  /**
   * Check to see if there are any pending instances to com.output from the filter
   *
   * @throws WekaException if a problem occurs
   */
  ...
  /**
   * If possible, get the com.output structure for the named connection type as a
   ...
   *
   * @param connectionName the name of the connection type to get the com.output
   *          structure for
   * @return the com.output structure as a header-only Instances object
   * @throws WekaException if a problem occurs
   */
  @Override
  public Instances outputStructureForConnectionType(String connectionName)
    ...
    if (incomingStructure != null) {
      try {
        com.weka.filters.Filter tempFilter =
          com.weka.filters.Filter.makeCopy(getFilter());
