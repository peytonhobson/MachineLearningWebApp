...
import com.weka.gui.beans.SubstringReplacerRules;
...
public class SubstringReplacer extends BaseStep {
  ...
  public Instances outputStructureForConnectionType(String connectionName)
    ...
    // we com.output the same structure as we receive
    if (getStepManager().numIncomingConnections() > 0) {
  ...
  public String getCustomEditorForStep() {
    return "com.weka.gui.knowledgeflow.steps.SubstringReplacerStepEditorDialog";
  }
}
