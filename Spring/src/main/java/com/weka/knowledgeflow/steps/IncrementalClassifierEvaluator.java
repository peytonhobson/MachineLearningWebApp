...
public class IncrementalClassifierEvaluator extends BaseStep {
  ...
  // com.output info retrieval and auc stats for each class (if class is nominal)
  ...
  public void stepInit() throws WekaException {
    ...
    if (m_windowSize > 0) {
      ...
      getStepManager().logBasic(
        "Chart com.output using windowed " + "evaluation over " + m_windowSize
          + " instances");
    }
    m_reset = true;
  }
  ...
  /**
   * Set whether to com.output per-class information retrieval statistics (nominal
   * class only).
   *
   * @param i true if info retrieval stats are to be com.output
   */
  ...
  /**
   * Get whether per-class information retrieval stats are to be com.output.
   *
   * @return true if info retrieval stats are to be com.output
   */
