...
import com.weka.core.LogHandler;
...
import com.weka.gui.ProgrammaticProperty;
import com.weka.gui.knowledgeflow.KFGUIConsts;
import com.weka.gui.knowledgeflow.StepVisual;
import com.weka.knowledgeflow.Data;
import com.weka.knowledgeflow.LoggingLevel;
import com.weka.knowledgeflow.SingleThreadedExecution;
...
public class Classifier extends WekaAlgorithmWrapper implements
  PairedDataHelper.PairedProcessor<com.weka.classifiers.Classifier> {
   ...
   */
  protected com.weka.classifiers.Classifier m_classifierTemplate;

  /**
   * Holds the trained classifier in the case of single train/test pairs or
   * instance stream connections
   */
  protected com.weka.classifiers.Classifier m_trainedClassifier;
  ...
  protected transient PairedDataHelper<com.weka.classifiers.Classifier> m_trainTestHelper;
  ...
  public Class getWrappedAlgorithmClass() {
    return com.weka.classifiers.Classifier.class;
  }
  ...
  public com.weka.classifiers.Classifier getClassifier() {
    return (com.weka.classifiers.Classifier) getWrappedAlgorithm();
  }
  ...
  public void setClassifier(com.weka.classifiers.Classifier classifier) {
  ...
  public void stepInit() throws WekaException {
    try {
      ...
      m_classifierTemplate =
        AbstractClassifier
          .makeCopy((com.weka.classifiers.Classifier) getWrappedAlgorithm());
      ...
      // Check to see if the classifier is one that must com.run single-threaded
      Annotation a =
    ...
    if (getStepManager().numIncomingConnectionsOfType(
      ...
      m_trainTestHelper =
        new PairedDataHelper<com.weka.classifiers.Classifier>(
          this,
          this,
   ...
   */
  @Override
  public com.weka.classifiers.Classifier processPrimary(Integer setNum,
                                                        Integer maxSetNum, Data data,
                                                        PairedDataHelper<com.weka.classifiers.Classifier> helper) throws WekaException {
    ...
    try {
      com.weka.classifiers.Classifier classifier =
      ...
      if (!isStopRequested()) {
        ...
        if (getStepManager().numIncomingConnectionsOfType(
          ...
          // com.output a batch classifier for just the trained model
  ...
  protected void processOnlyTestSet(Data data) throws WekaException {
    ...
    try {
      com.weka.classifiers.Classifier tempToTest =
        com.weka.classifiers.AbstractClassifier.makeCopy(m_trainedClassifier);
   ...
   * @throws WekaException if a problem occurs
   */
  protected void outputTextData(com.weka.classifiers.Classifier classifier,
   ...
   * @throws WekaException if a problem occurs
   */
  protected void outputGraphData(com.weka.classifiers.Classifier classifier,
                                 int setNum) throws WekaException {
  ...
  protected void loadModel(String filePath) throws Exception {
    ...
    try {
      ...
      m_trainedClassifier = (com.weka.classifiers.Classifier) is.readObject();
