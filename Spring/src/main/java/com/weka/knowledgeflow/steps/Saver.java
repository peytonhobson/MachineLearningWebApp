...
import com.weka.core.converters.DatabaseConverter;
import com.weka.core.converters.DatabaseSaver;
...
import com.weka.knowledgeflow.StepManagerImpl;
...
/**
 * Step that wraps com.weka.core.converters.Saver classes
 *
...
public class Saver extends WekaAlgorithmWrapper implements Serializable {
  ...
  protected com.weka.core.converters.Saver m_saver;
  ...
  public Class getWrappedAlgorithmClass() {
    return com.weka.core.converters.Saver.class;
  }
   ...
   */
  public com.weka.core.converters.Saver getSaver() {
    return (com.weka.core.converters.Saver) getWrappedAlgorithm();
  }
  ...
  public void setSaver(com.weka.core.converters.Saver saver) {
  ...
  public void stepInit() throws WekaException {
    ...
    if (!(getWrappedAlgorithm() instanceof com.weka.core.converters.Saver)) {
  ...
  protected void saveBatch(Instances data, Integer setNum, Integer maxSetNum,
    ...
    try {
      com.weka.core.converters.Saver saver =
        (com.weka.core.converters.Saver) new SerializedObject(m_saver).getObject();
  ...
  public synchronized void processIncoming(Data data) throws WekaException {
    ...
    if (m_saver == null) {
      try {
        m_saver =
          (com.weka.core.converters.Saver) new SerializedObject(
      ...
      if (data.getConnectionName().equalsIgnoreCase(StepManager.CON_INSTANCE)) {
        ...
        if (forStructure != null) {
          // processing();
          m_saver.setRetrieval(com.weka.core.converters.Saver.INCREMENTAL);
    ...
    if (data.getConnectionName().equals(StepManager.CON_DATASET)
      ...
      m_saver.setRetrieval(com.weka.core.converters.Saver.BATCH);
      Instances theData =
  ...
  protected String sanitizeFilename(String filename) {
    filename =
      filename.replaceAll("\\\\", "_").replaceAll(":", "_")
        .replaceAll("/", "_");
    filename =
      Utils.removeSubstring(filename, "com.weka.filters.supervised.instance.");
    filename =
      Utils.removeSubstring(filename, "com.weka.filters.supervised.attribute.");
    filename =
      Utils.removeSubstring(filename, "com.weka.filters.unsupervised.instance.");
    filename =
      Utils.removeSubstring(filename, "com.weka.filters.unsupervised.attribute.");
    filename = Utils.removeSubstring(filename, "com.weka.clusterers.");
    filename = Utils.removeSubstring(filename, "com.weka.associations.");
    filename = Utils.removeSubstring(filename, "com.weka.attributeSelection.");
    filename = Utils.removeSubstring(filename, "com.weka.estimators.");
    filename = Utils.removeSubstring(filename, "com.weka.datagenerators.");
  ...
  public String getCustomEditorForStep() {
    return "com.weka.gui.knowledgeflow.steps.SaverStepEditorDialog";
  }
}
