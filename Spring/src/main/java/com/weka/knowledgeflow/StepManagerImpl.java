...
import com.weka.knowledgeflow.steps.KFStep;
...
public class StepManagerImpl implements StepManager {
  ...
  /**
   * Used when interrogating the managed step for what com.output connections it can
  ...
  /**
   * True if the managed step must com.run single threaded - i.e. in an executor
  ...
  /**
   * Set whether the managed step must com.run single-threaded. I.e. in an executor
   ...
   *
   * @param mustRunSingleThreaded true if the managed step must com.run
   *          single-threaded
   */
  @Override
  ...
  /**
   * Get whether the managed step must com.run single-threaded. I.e. in an executor
   * service with one worker thread, thus effectively preventing more than one
   * copy of the step from executing at any one point in time
   *
   * @return true if the managed step must com.run single-threaded
   */
  @Override
   ...
   *
   * @param listener the com.output listener to register
   ...
   *
   * @param listener the com.output listener to de-register
   ...
   * the connection type in each Data object to be com.output so that the
   ...
   *
   * @param message the message to com.output
   */
  @Override
