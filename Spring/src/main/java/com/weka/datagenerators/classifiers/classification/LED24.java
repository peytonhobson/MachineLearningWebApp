...
package com.weka.datagenerators.classifiers.classification;
...
import com.weka.datagenerators.ClassificationGenerator;

/**
 * <!-- globalinfo-start --> This generator produces data for a display with 7
 * LEDs. The original com.output consists of 10 concepts and 7 boolean attributes.
 ...
 * <pre>
 * -o &lt;file&gt;
 *  The name of the com.output file, otherwise the generated data is
 *  printed to stdout.
 * </pre>
 * 
 * <pre>
...
public class LED24 extends ClassificationGenerator implements
  ...
  /** used for generating the com.output, i.e., the additional noise attributes */
  ...
  public String globalInfo() {
    return "This generator produces data for a display with 7 LEDs. The original "
      + "com.output consists of 10 concepts and 7 boolean attributes. Here, in "
   ...
   * this string is added at the beginning of the produced com.output as ARFF file
   ...
   * this string is added at the end of theproduces com.output as ARFF file type.
   * 
   * @return string contains info about the generated rules
