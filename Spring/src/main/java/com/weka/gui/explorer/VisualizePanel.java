...
import com.weka.gui.visualize.VisualizeUtils;
 ...
 * @see MatrixPanel
 */
@PerspectiveInfo(ID = "com.weka.gui.workbench.visualizepanel", title = "Visualize",
...
public class VisualizePanel extends AbstractPerspective implements
  ...
  public static class ScatterDefaults extends Defaults {
    public static final String ID = "com.weka.gui.workbench.visualizepanel";
