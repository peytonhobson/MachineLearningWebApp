 ...
 * file <code>com.weka/gui/explorer/Explorer.props</code>.
 * 
...
public class ExplorerDefaults implements Serializable {
  ...
  public static String[] getTabs() {
    ...
    tabs = get(
      "Tabs",
      "com.weka.gui.explorer.ClassifierPanel,com.weka.gui.explorer.ClustererPanel,com.weka.gui.explorer.AssociationsPanel,com.weka.gui.explorer.AttributeSelectionPanel,com.weka.gui.explorer.VisualizePanel");
    result = tabs.split(",");
  ...
  public static Object getFilter() {
    return getObject("Filter", "", com.weka.filters.Filter.class);
  }
  ...
  public static Object getClassifier() {
    ...
    result = getObject("Classifier",
      com.weka.classifiers.rules.ZeroR.class.getName(),
      com.weka.classifiers.Classifier.class);
    if (result == null) {
      result = new com.weka.classifiers.rules.ZeroR();
    }
  ...
  /**
   * returns whether the built model is com.output.
   * 
   * @return true if the built model is com.output
   */
  ...
  /**
   * returns whether the models built for the training set are com.output
   *
   * @return true if the models built for the training set are com.output
   */
  ...
  /**
   * returns whether additional per-class stats of the classifier are com.output.
   * 
   * @return true if stats are com.output
   */
  ...
  /**
   * returns whether the confusion matrix for the classifier is com.output.
   * 
   * @return true if matrix is com.output
   */
  ...
  /**
   * returns whether the predictions of the classifier are com.output as well.
   * 
   * @return true if predictions are com.output as well
   */
  ...
  /**
   * returns the string with the additional indices to com.output alongside the
   * predictions.
   * 
   * @return the indices, 0 if none are com.output
   */
  ...
  /**
   * returns whether the source of a sourcable Classifier is com.output in the
   * classify tab.
   * 
   * @return true if the source code is com.output
   */
  ...
  public static ClassifierErrorsPlotInstances getClassifierErrorsPlotInstances() {
    ...
    try {
      options = Utils.splitOptions(get("ClassifierErrorsPlotInstances",
        "com.weka.gui.explorer.ClassifierErrorsPlotInstances"));
      classname = options[0];
      options[0] = "";
  ...
  public static Object getClusterer() {
    ...
    result = getObject("Clusterer", com.weka.clusterers.EM.class.getName(),
      com.weka.clusterers.Clusterer.class);
    if (result == null) {
      result = new com.weka.clusterers.EM();
    }
  ...
  public static ClustererAssignmentsPlotInstances getClustererAssignmentsPlotInstances() {
    ...
    try {
      options = Utils.splitOptions(get("ClustererAssignmentsPlotInstances",
        "com.weka.gui.explorer.ClustererAssignmentsPlotInstances"));
      classname = options[0];
      options[0] = "";
  ...
  public static Object getAssociator() {
    ...
    result = getObject("Associator", com.weka.associations.Apriori.class.getName(),
      com.weka.associations.Associator.class);
    if (result == null) {
      result = new com.weka.associations.Apriori();
    }
  ...
  public static Object getASEvaluator() {
    ...
    result = getObject("ASEvaluation",
      com.weka.attributeSelection.CfsSubsetEval.class.getName(),
      com.weka.attributeSelection.ASEvaluation.class);
    if (result == null) {
      result = new com.weka.attributeSelection.CfsSubsetEval();
    }
  ...
  public static Object getASSearch() {
    ...
    result = getObject("ASSearch",
      com.weka.attributeSelection.BestFirst.class.getName(),
      com.weka.attributeSelection.ASSearch.class);
    if (result == null) {
      result = new com.weka.attributeSelection.BestFirst();
    }
