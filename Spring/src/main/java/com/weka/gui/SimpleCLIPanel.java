...
import com.weka.core.Trie;
import com.weka.core.Utils;
import com.weka.core.WekaPackageManager;
import com.weka.gui.knowledgeflow.StepVisual;
import com.weka.gui.scripting.ScriptingPanel;
import com.weka.gui.simplecli.AbstractCommand;
import com.weka.gui.simplecli.Help;
 ...
 * System.out and System.err are redirected to an com.output area. Features a simple
...
public class SimpleCLIPanel extends ScriptingPanel implements ActionListener,
  ...
  /** The com.output area canvas added to the frame. */
  ...
  public static class ClassRunner extends Thread {
    ...
    /** True if the class to be executed is com.weka.Run */
    ...
    public ClassRunner(SimpleCLIPanel owner, Class<?> theClass, String[] commandArgs)
      ...
      m_Owner = owner;
      m_classIsRun = (theClass.getClass().getName().equals("com.weka.Run"));
    ...
    public void run() {
      ...
      if (outOld != null) {
        ...
        outNew.close();
        System.setOut(outOld);
        System.out.println("Finished redirecting com.output to '" + outFilename
          + "'.");
      }
    }
  }
  ...
  /**
   * Returns the text area that is used for displaying com.output on stdout and
   * stderr.
   * 
