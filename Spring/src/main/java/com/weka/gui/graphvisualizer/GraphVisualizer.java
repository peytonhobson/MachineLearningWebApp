 ...
 *
 */
package com.weka.gui.graphvisualizer;
 ...
 * to use only this class in com.weka.gui.graphvisulizer package to visualize a
...
public class GraphVisualizer extends JPanel implements GraphConstants,
  ...
  public GraphVisualizer() {
    ...
    if (tempURL != null) {
      ...
      System.err.println(ICONPATH
        + "save.gif not found for com.weka.gui.graphvisualizer.Graph");
    }
    ...
    if (tempURL != null) {
      ...
      System.err.println(ICONPATH
        + "zoomin.gif not found for com.weka.gui.graphvisualizer.Graph");
    }
    ...
    if (tempURL != null) {
      ...
      System.err.println(ICONPATH
        + "zoomout.gif not found for com.weka.gui.graphvisualizer.Graph");
    }
    ...
    if (tempURL != null) {
      ...
      System.err.println(ICONPATH
        + "extra.gif not found for com.weka.gui.graphvisualizer.Graph");
    }
    ...
    jBtExtraControls.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent ae) {
        ...
        if (d.width == 0 || d.height == 0) {
           ...
           * 
           * public void com.run() { while(h<toh || w<tow) { if((h+10)<toh) h += 10;
  ...
  /**
   * Table com.Model for the Table that shows the probability distribution for a
   * node
   */
