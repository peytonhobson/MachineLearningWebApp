...
public class Join extends JPanel implements BeanCommon, Visible, Serializable,
  ...
  /**
   * Notify instance listeners of an com.output instance
   * 
  ...
  /**
   * Notify data listeners of an com.output data set
   * 
   * @param e the event to notify with
   */
  ...
  /**
   * Get the com.output instances structure given an input event type
   * 
   * @param eventName the name of the input event type
   * @return the com.output instances structure (or null)
   */
  @Override
