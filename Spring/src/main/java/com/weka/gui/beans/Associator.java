...
import com.weka.associations.Apriori;
...
/**
 * Bean that wraps around com.weka.associations. If used in a non-graphical
 * environment, options for the wrapped associator can be provided by setting an
 * environment variable: com.weka.gui.beans.associator.schemeOptions. The value of
...
public class Associator extends JPanel implements BeanCommon, Visible,
  ...
  private com.weka.associations.Associator m_Associator = new Apriori();
   ...
   * 
   * @param c a <code>com.weka.associations.Associator</code> value
   */
  public void setAssociator(com.weka.associations.Associator c) {
   ...
   * 
   * @return a <code>com.weka.associations.Associator</code> value
   */
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof com.weka.associations.Associator)) {
      throw new IllegalArgumentException(algorithm.getClass() + " : incorrect "
        + "type of algorithm (Associator)");
    }
    setAssociator((com.weka.associations.Associator) algorithm);
  }
            ...
            public void run() {
              try {
                if (trainingData != null) {
                  ...
                  if (m_Associator instanceof com.weka.core.Drawable
                    && m_graphListeners.size() > 0) {
                    String grphString = ((com.weka.core.Drawable) m_Associator)
                      .graph();
                    int grphType = ((com.weka.core.Drawable) m_Associator)
                      .graphType();
  ...
  private void buildAssociations(Instances data) throws Exception {
    ...
    if (m_env != null && m_Associator instanceof OptionHandler) {
      String opts = m_env
        .getVariableValue("com.weka.gui.beans.associator.schemeOptions");
  ...
  public boolean eventGeneratable(String eventName) {
    if (eventName.compareTo("text") == 0 || eventName.compareTo("graph") == 0
      ...
      if (eventName.compareTo("graph") == 0
        && !(m_Associator instanceof com.weka.core.Drawable)) {
        return false;
      }
