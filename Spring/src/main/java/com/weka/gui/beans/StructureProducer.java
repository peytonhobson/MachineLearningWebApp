 ...
 * it is not possible to know the structure of the encapsulated com.output
...
public interface StructureProducer {
  ...
  /**
   * Get the structure of the com.output encapsulated in the named
   ...
   * 
   * @param eventName the name of the com.output event that encapsulates
   * the requested com.output.
   * 
   * @return the structure of the com.output encapsulated in the named
