...
import com.weka.core.converters.DatabaseLoader;
import com.weka.core.converters.FileSourcedConverter;
import com.weka.core.converters.Loader.StructureNotReadyException;
import com.weka.gui.Logger;

/**
 * Loads data sets using com.weka.core.converter classes
 * 
...
public class Loader extends AbstractDataSource implements Startable,
   ...
   * Loader
   */
  private com.weka.core.converters.Loader m_Loader = new ArffLoader();
    ...
    public void run() {
      ...
      try {
        ...
        if (instanceGeneration) {
          ...
          try {
            m_Loader.reset();
            m_Loader.setRetrieval(com.weka.core.converters.Loader.INCREMENTAL);
          ...
          m_Loader.reset();
          m_Loader.setRetrieval(com.weka.core.converters.Loader.BATCH);
   ...
   * 
   * @param loader a <code>com.weka.core.converters.Loader</code> value
   */
  public void setLoader(com.weka.core.converters.Loader loader) {
  ...
  /**
   * Get the structure of the com.output encapsulated in the named event. If the
   ...
   * returned.
   * 
   * @param eventName the name of the com.output event that encapsulates the
   *          requested com.output.
   * 
   * @return the structure of the com.output encapsulated in the named event or null
   ...
   * Get the loader
   * 
   * @return a <code>com.weka.core.converters.Loader</code> value
   */
  public com.weka.core.converters.Loader getLoader() {
    return m_Loader;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof com.weka.core.converters.Loader)) {
      throw new IllegalArgumentException(algorithm.getClass() + " : incorrect "
        + "type of algorithm (Loader)");
    }
    setLoader((com.weka.core.converters.Loader) algorithm);
  }
  ...
  public boolean eventGeneratable(String eventName) {
    if (eventName.compareTo("instance") == 0) {
      if (!(m_Loader instanceof com.weka.core.converters.IncrementalConverter)) {
        return false;
      }
      if (m_dataSetEventTargets > 0) {
        return false;
    ...
    if (eventName.compareTo("dataSet") == 0) {
      if (!(m_Loader instanceof com.weka.core.converters.BatchConverter)) {
        return false;
      }
   ...
   * Set a logger
   * 
   * @param logger a <code>com.weka.gui.Logger</code> value
   */
  @Override
