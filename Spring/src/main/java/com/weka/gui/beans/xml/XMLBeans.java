...
package com.weka.gui.beans.xml;
...
import com.weka.core.converters.ConverterUtils;
import com.weka.core.xml.XMLBasicSerialization;
import com.weka.core.xml.XMLDocument;
import com.weka.gui.beans.BeanCommon;
import com.weka.gui.beans.BeanConnection;
import com.weka.gui.beans.BeanInstance;
import com.weka.gui.beans.BeanVisual;
import com.weka.gui.beans.MetaBean;
import com.weka.gui.beans.Visible;
...
public class XMLBeans extends XMLBasicSerialization {
  ...
  public void clear() throws Exception {
    ...
    // allow
    m_Properties.addAllowed(com.weka.gui.beans.BeanInstance.class, "x");
    m_Properties.addAllowed(com.weka.gui.beans.BeanInstance.class, "y");
    m_Properties.addAllowed(com.weka.gui.beans.BeanInstance.class, "bean");
    m_Properties.addAllowed(com.weka.gui.beans.Saver.class, "wrappedAlgorithm");
    m_Properties.addAllowed(com.weka.gui.beans.Loader.class, "wrappedAlgorithm");
    m_Properties.addAllowed(com.weka.gui.beans.Saver.class,
      "relationNameForFilename");
    if (getDataType() == DATATYPE_LAYOUT) {
      m_Properties.addAllowed(com.weka.gui.beans.Loader.class, "beanContext");
    } else {
      m_Properties.addIgnored(com.weka.gui.beans.Loader.class, "beanContext"); // TODO:
                                                                           // more
                                                                           // classes???
    }
    m_Properties.addAllowed(com.weka.gui.beans.Filter.class, "filter");
    m_Properties.addAllowed(com.weka.gui.beans.Associator.class, "associator");
    m_Properties
      .addAllowed(com.weka.gui.beans.Classifier.class, "wrappedAlgorithm");
    m_Properties.addAllowed(com.weka.gui.beans.Clusterer.class, "wrappedAlgorithm");
    m_Properties.addAllowed(com.weka.gui.beans.Classifier.class, "executionSlots");
    m_Properties.addAllowed(com.weka.gui.beans.Classifier.class, "blockOnLastFold");
    m_Properties.addAllowed(com.weka.gui.beans.Classifier.class,
    ...
    m_Properties.addAllowed(com.weka.classifiers.Classifier.class, "debug");
    m_Properties.addAllowed(com.weka.classifiers.Classifier.class, "options");
    m_Properties.addAllowed(com.weka.associations.Associator.class, "options");
    m_Properties.addAllowed(com.weka.clusterers.Clusterer.class, "options");
    m_Properties.addAllowed(com.weka.filters.Filter.class, "options");
    m_Properties.addAllowed(com.weka.core.converters.Saver.class, "options");
    m_Properties.addAllowed(com.weka.core.converters.Loader.class, "options");

    m_Properties
      .addAllowed(com.weka.core.converters.DatabaseSaver.class, "options");
    m_Properties.addAllowed(com.weka.core.converters.DatabaseLoader.class,
      "options");
    m_Properties.addAllowed(com.weka.core.converters.TextDirectoryLoader.class,
      "options");

    // we assume that classes implementing SplitEvaluator also implement
    // OptionHandler
    m_Properties.addAllowed(com.weka.experiment.SplitEvaluator.class, "options");
    // we assume that classes implementing ResultProducer also implement
    // OptionHandler
    m_Properties.addAllowed(com.weka.experiment.ResultProducer.class, "options");
    ...
    m_CustomMethods.register(this, com.weka.gui.beans.BeanInstance.class,
      "BeanInstance");
    m_CustomMethods.register(this, com.weka.gui.beans.BeanConnection.class,
      "BeanConnection");
    m_CustomMethods.register(this, com.weka.gui.beans.BeanVisual.class,
      "BeanVisual");
    m_CustomMethods.register(this, com.weka.gui.beans.Saver.class, "BeanSaver");
    m_CustomMethods.register(this, com.weka.gui.beans.MetaBean.class, "MetaBean");
  ...
  public Object readBeanInstance(Element node) throws Exception {
    ...
    if (beaninst.getBean() instanceof com.weka.gui.beans.Visible) {
  ...
  public Element writeBeanLoader(Element parent, Object o, String name)
    ...
    Element node;
    com.weka.gui.beans.Loader loader;
    ...
    loader = (com.weka.gui.beans.Loader) o;
  ...
  public Element writeBeanSaver(Element parent, Object o, String name)
    ...
    Element node;
    com.weka.gui.beans.Saver saver;
    ...
    saver = (com.weka.gui.beans.Saver) o;
  ...
  public Element writeLoader(Element parent, Object o, String name)
    ...
    Element node;
    com.weka.core.converters.Loader loader;
    File file;
    boolean known;
    ...
    loader = (com.weka.core.converters.Loader) o;
    node = addElement(parent, name, loader.getClass().getName(), false);
    known = true;
    file = null;

    // file
    if (loader instanceof com.weka.core.converters.AbstractFileLoader) {
      file = ((com.weka.core.converters.AbstractFileLoader) loader).retrieveFile();
    } else {
      known = false;
    }
    ...
    if (loader instanceof com.weka.core.converters.FileSourcedConverter) {
      boolean relative = ((com.weka.core.converters.FileSourcedConverter) loader)
        .getUseRelativePath();
    ...
    if ((file == null) || (file.isDirectory())) {
      ...
      boolean notAbsolute = (((com.weka.core.converters.AbstractFileLoader) loader)
        .getUseRelativePath()
    ...
    if (loader instanceof com.weka.core.OptionHandler) {
      String[] opts = ((com.weka.core.OptionHandler) loader).getOptions();
  ...
  public Object readLoader(Element node) throws Exception {
    ...
    if (result instanceof com.weka.core.converters.FileSourcedConverter) {
      ((com.weka.core.converters.FileSourcedConverter) result)
    ...
    if (file != null) {
      ...
      if (containsEnv || fl.exists()
        ...
        ((com.weka.core.converters.AbstractFileLoader) result).setSource(new File(
          file));
      } else {
  ...
  public Element writeSaver(Element parent, Object o, String name)
    ...
    Element node;
    com.weka.core.converters.Saver saver;
    String prefix;
    String dir;
    boolean known;
    ...
    saver = (com.weka.core.converters.Saver) o;
    node = addElement(parent, name, saver.getClass().getName(), false);
    known = true;
    prefix = "";
    dir = "";
    ...
    // file
    if (saver instanceof com.weka.core.converters.AbstractFileSaver) {
      ((com.weka.core.converters.AbstractFileSaver) saver).retrieveFile();
      prefix = ((com.weka.core.converters.AbstractFileSaver) saver).filePrefix();
      dir = ((com.weka.core.converters.AbstractFileSaver) saver).retrieveDir();
      // Replace any windows file separators with forward slashes (Java under
      // windows can
      // read paths with forward slashes (apparantly)
      dir = dir.replace('\\', '/');
    ...
    Boolean relativeB = null;
    if (saver instanceof com.weka.core.converters.FileSourcedConverter) {
      boolean relative = ((com.weka.core.converters.FileSourcedConverter) saver)
        .getUseRelativePath();
      relativeB = new Boolean(relative);
    }
    ...
    /*
     * } else { String path = (((com.weka.core.converters.FileSourcedConverter)
    ...
    if (saver instanceof com.weka.core.OptionHandler) {
      String[] opts = ((com.weka.core.OptionHandler) saver).getOptions();
      invokeWriteToXML(node, opts, VAL_OPTIONS);
    }
  ...
  public Object readSaver(Element node) throws Exception {
    ...
    if ((dir != null) && (prefix != null)) {
      ((com.weka.core.converters.AbstractFileSaver) result).setDir(dir);
      ((com.weka.core.converters.AbstractFileSaver) result).setFilePrefix(prefix);
    }
