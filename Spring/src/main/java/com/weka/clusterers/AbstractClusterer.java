...
public abstract class AbstractClusterer
  ...
  /** Whether the clusterer is com.run in debug mode. */
   ...
   * 
   * -D <br>
   * If set, clusterer is com.run in debug mode and may com.output additional info to
   * the console.
   * <p>
   * 
   ...
   * 
   * @param clusterer the clusterer to com.run
