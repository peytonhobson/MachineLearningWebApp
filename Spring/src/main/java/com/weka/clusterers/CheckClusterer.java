 ...
 * you implement a clusterer using the WEKA.libraries, you should com.run the checks
 ...
 * Typical usage:
 * <p/>
 * <code>java com.weka.clusterers.CheckClusterer -W clusterer_name
 ...
 * </li>
 * </ul>
 * Running CheckClusterer with the debug option set will com.output the training
 * dataset for any failed tests.
 * <p/>
 * 
 * The <code>com.weka.clusterers.AbstractClustererTest</code> uses this class to
 ...
 *  eg: com.weka.clusterers.SimpleKMeans
 *  (default com.weka.clusterers.SimpleKMeans)
 * </pre>
 * 
 * <pre>
 * Options specific to clusterer com.weka.clusterers.SimpleKMeans:
 * </pre>
 * 
 * <pre>
 * -N &lt;num&gt;
...
public class CheckClusterer extends CheckScheme {
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option("\tFull name of the clusterer analyzed.\n"
      + "\teg: com.weka.clusterers.SimpleKMeans\n"
      + "\t(default com.weka.clusterers.SimpleKMeans)", "W", 1, "-W"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() == 0) {
      tmpStr = com.weka.clusterers.SimpleKMeans.class.getName();
    }
    setClusterer((Clusterer) forName("com.weka.clusterers", Clusterer.class,
