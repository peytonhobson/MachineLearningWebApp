 ...
 * <pre>
 * -R &lt;index&gt;
 *  Set the index of the column containing the com.run number
 * </pre>
 * 
 * <pre>
 * -F &lt;index&gt;
 ...
 * <pre>
 * -gnuplot
 *  Produce table comparisons com.output suitable for GNUPlot
 * </pre>
 * 
 * <!-- options-end -->
 * 
...
public class PairedTTester implements OptionHandler, Tester, RevisionHandler {
  ...
  /** The index of the column containing the com.run number */
  protected int m_RunColumn = 0;

  /** The option setting for the com.run number column (-1 means last) */
  ...
  /** the instance of the class to produce the com.output. */
  ...
  protected class Dataset implements RevisionHandler, Serializable {
    ...
    /**
     * Sorts the instances in the dataset by the com.run number.
     * 
  ...
  protected class Resultset implements RevisionHandler, Serializable {
    ...
    protected String templateString() {
      ...
      for (int m_ResultsetKeyColumn : m_ResultsetKeyColumns) {
        ...
        // compact the string
        tempResult = Utils.removeSubstring(tempResult, "com.weka.classifiers.");
        tempResult = Utils.removeSubstring(tempResult, "com.weka.filters.");
    ...
    /**
     * Sorts the instances in each dataset by the com.run number.
     * 
     * @param runColumn a value of type 'int'
     */
    public void sort(int runColumn) {
  ...
  protected String templateString(Instance template) {
    ...
    if (result.startsWith("com.weka.classifiers.")) {
      result = result.substring("com.weka.classifiers.".length());
    }
    return result.trim();
  }

  /**
   * Sets the matrix to use to produce the com.output.
   * 
   * @param matrix the instance to use to produce the com.output
   * @see ResultMatrix
   */
  @Override
  ...
  /**
   * Gets the instance that produces the com.output.
   * 
   * @return the instance to produce the com.output
   */
  @Override
  ...
  /**
   * Separates the instances into resultsets and by dataset/com.run.
   * 
  ...
  protected void prepareData() throws Exception {
    ...
    for (int i = 0; i < m_Instances.numInstances(); i++) {
      ...
      if (current.isMissing(m_RunColumn)) {
        throw new Exception("Instance has missing value in com.run " + "column!\n"
          + current);
      }
      for (int m_ResultsetKeyColumn : m_ResultsetKeyColumns) {
    ...
    // Tell each resultset to sort on the com.run column
    for (int j = 0; j < m_Resultsets.size(); j++) {
      Resultset resultset = m_Resultsets.get(j);
      if (m_FoldColumn >= 0) {
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
      ...
      "-D <index,index2-index4,...>"));
    newVector.addElement(new Option(
      "\tSet the index of the column containing the com.run number", "R", 1,
      "-R <index>"));
    newVector.addElement(new Option(
    ...
    newVector.addElement(new Option(
      ...
      "-S <significance level>"));
    newVector.addElement(new Option(
            "\tSet the result matrix (classname plus parameters).\n\t(default: com.weka.experiment.ResultMatrixPlainText)",
            "result-matrix", 1,
    ...
    newVector.addElement(new Option(
      "\tProduce table comparisons com.output suitable for GNUPlot", "gnuplot", 0,
      "-gnuplot"));
    newVector.addElement(new Option(
            "",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (outputOption.length() != 0) {
      ...
      resultMatrixSpec[0] = "";
      ResultMatrix resultMatrix = (ResultMatrix) Utils.forName(Class.forName("com.weka.experiment.ResultMatrix"),
