...
public class InstanceQuery extends DatabaseUtils implements OptionHandler,
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option("\tEnables debug com.output.", "D", 0, "-D"));
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      try {
        ...
        System.err.println("Options for com.weka.experiment.InstanceQuery:\n");
      ...
      // com.output an instance at a time (rather than having to convert
