...
import com.weka.filters.unsupervised.attribute.MakeIndicator;
import com.weka.filters.unsupervised.instance.RemoveWithValues;

/**
 <!-- globalinfo-start -->
 * A metaclassifier for handling multi-class datasets with 2-class classifiers.
 * This classifier is also capable of applying error correcting com.output codes for increased accuracy.
 ...
 * 
 * <pre> 
 * Options specific to classifier com.weka.classifiers.functions.Logistic:
 * </pre>
 * 
 * <pre> -D
...
public class MultiClassClassifier 
  ...
  /** Internal copy of the class attribute for com.output purposes */
  ...
  public MultiClassClassifier() {
    ...
    m_Classifier = new com.weka.classifiers.functions.Logistic();
  }
  ...
  protected String defaultClassifierString() {
    ...
    return "com.weka.classifiers.functions.Logistic";
  }
  ...
  public String globalInfo() {
    ...
    return "A metaclassifier for handling multi-class datasets with 2-class "
      ...
      + "applying error correcting com.output codes for increased accuracy. "
      + "If the base classifier cannot handle instance weights, and the instance weights are not uniform, "
      + "the data will be resampled with replacement based on the weights before being passed to the base classifier.";
  }
