 ...
 *  (default: com.weka.classifiers.trees.RandomTree)</pre>
 * 
 * <pre> 
 * Options specific to classifier com.weka.classifiers.trees.RandomTree:
 * </pre>
 * 
...
public class RandomCommittee 
  ...
  public RandomCommittee() {
    ...
    m_Classifier = new com.weka.classifiers.trees.RandomTree();
  }
