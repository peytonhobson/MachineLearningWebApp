...
package com.weka.classifiers.rules;
...
import com.weka.classifiers.lazy.IBk;
 ...
 *  by its options.
 *  eg: "com.weka.attributeSelection.BestFirst -D 1"
 *  (default com.weka.attributeSelection.BestFirst)
 * </pre>
 * 
 * <pre>
 * -X &lt;number of folds&gt;
 ...
 * 
 * <pre>
 * Options specific to search method com.weka.attributeSelection.BestFirst:
 * </pre>
 * 
 * <pre>
 * -P &lt;start set&gt;
...
public class DecisionTable extends AbstractClassifier implements OptionHandler,
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
      "\tFull class name of search method, followed\n" + "\tby its options.\n"
        + "\teg: \"com.weka.attributeSelection.BestFirst -D 1\"\n"
        + "\t(default com.weka.attributeSelection.BestFirst)", "S", 1,
      "-S <search method specification>"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (searchString.length() == 0) {
      searchString = com.weka.attributeSelection.BestFirst.class.getName();
    }
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (m_theInstances.classAttribute().isNumeric()) {
      m_disTransform = new com.weka.filters.unsupervised.attribute.Discretize();
      m_classIsNominal = false;

      // use binned discretisation if the class is numeric
      ((com.weka.filters.unsupervised.attribute.Discretize) m_disTransform)
        .setBins(10);
      ((com.weka.filters.unsupervised.attribute.Discretize) m_disTransform)
      ...
      m_disTransform = new com.weka.filters.supervised.attribute.Discretize();
      ((com.weka.filters.supervised.attribute.Discretize) m_disTransform)
