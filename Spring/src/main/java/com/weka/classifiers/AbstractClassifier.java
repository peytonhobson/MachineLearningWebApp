...
public abstract class AbstractClassifier implements Classifier, BatchPredictor,
   ...
   *
   * @param classifier the classifier to com.run
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
      "\tThe number of decimal places for the com.output of numbers in the model"
   ...
   * <p>
   *
   * -com.output-debug-info <br>
   * If set, classifier is com.run in debug mode and may com.output additional info to
   * the console.
   * <p>
   *
  ...
  public String debugTipText() {
    return "If set to true, classifier may com.output additional info to "
      + "the console.";
  }
  ...
  public String numDecimalPlacesTipText() {
    return "The number of decimal places to be used for the com.output of numbers in "
      + "the model.";
  }
  ...
  public void run(Object toRun, String[] options) throws Exception {
    if (!(toRun instanceof Classifier)) {
      throw new IllegalArgumentException("Object to com.run is not a Classifier!");
    }
