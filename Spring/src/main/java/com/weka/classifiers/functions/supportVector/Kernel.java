...
public abstract class Kernel implements Serializable, OptionHandler,
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option(
      "\tEnables debugging com.output (if available) to be printed.\n"
        + "\t(default: off)", "com.output-debug-info", 0, "-com.output-debug-info"));
  ...
  public String[] getOptions() {
    ...
    if (getDebug()) {
      result.add("-com.output-debug-info");
    }
  ...
  /**
   * Enables or disables the com.output of debug information (if the derived kernel
   * supports that)
   * 
   * @param value whether to com.output debugging information
   */
  ...
  /**
   * Gets whether debugging com.output is turned on or not.
   * 
   * @return true if debugging com.output is produced.
   */
  ...
  public String debugTipText() {
    return "Turns on the com.output of debugging information.";
  }
