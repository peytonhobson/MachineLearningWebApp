 ...
 * <pre>
 * -Z &lt;num&gt;
 *  The size of the com.output dataset - number of instances
 *  (default 100)
 * </pre>
 * 
 * <!-- options-end -->
...
public class ReservoirSample extends Filter implements UnsupervisedFilter,
  ...
  /**
   * Creates a subsample of the current set of input instances. The com.output
   * instances are pushed onto the com.output queue for collection.
   */
