...
public class Add extends Filter implements UnsupervisedFilter,
  ...
  public boolean setInputFormat(Instances instanceInfo) throws Exception {
    ...
    // (otherwise the length of the input/com.output indices differ)
  ...
  public boolean input(Instance instance) {
    ...
    // First copy string values from input to com.output
    copyValues(inst, true, inst.dataset(), outputFormatPeek());

    // Insert the new attribute and reassign to com.output
