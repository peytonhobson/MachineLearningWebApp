...
public class MakeIndicator extends Filter implements UnsupervisedFilter,
   ...
   * available for com.output immediately.
   * 
  ...
  public String numericTipText() {
    ...
    return "Determines whether the com.output indicator attribute is numeric. If "
      + "this is set to false, the com.output attribute will be nominal.";
  }
