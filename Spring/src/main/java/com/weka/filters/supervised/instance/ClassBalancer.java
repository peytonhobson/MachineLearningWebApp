...
package com.weka.filters.supervised.instance;
 ...
 *  The number of discretization intervals to use when the class is numeric (default of com.weka.attribute.unsupervised.Discretize).</pre>
 *
