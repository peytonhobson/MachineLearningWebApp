 ...
 * (if any).<br/>
 * Eg. -s "com.weka.attributeSelection.BestFirst -N 10"
 * <p/>
 * 
...
public class AttributeSelection implements Serializable, RevisionHandler {
  ...
  /**
   * Return the number of attributes selected from the most recent com.run of
   * attribute selection
   * 
   ...
   * attributes chosen by the last com.run of attribute selection.
   * 
  ...
  public static String SelectAttributes(ASEvaluation ASEvaluator,
    ...
    try {
      ...
      if (searchName.length() != 0) {
        ...
        try {
          searchClassName = new String("com.weka.attributeSelection.Ranker");
          searchMethod =
