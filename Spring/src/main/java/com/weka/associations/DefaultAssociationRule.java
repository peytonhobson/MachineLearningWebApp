...
public class DefaultAssociationRule extends AssociationRule 
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getPremise()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getConsequence()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getPrimaryMetricName()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getPrimaryMetricValue()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getNamedMetricValue(java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getNumberOfMetricsForRule()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getMetricNamesForRule()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getMetricValuesForRule()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getPremiseSupport()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getConsequenceSupport()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getTotalSupport()
   */
  ...
  /* (non-Javadoc)
   * @see com.weka.associations.AssociationRule#getTotalTransactions()
   */
