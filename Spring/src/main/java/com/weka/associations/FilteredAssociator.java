...
import com.weka.filters.MultiFilter;
 ...
 *  com.weka.filters.unsupervised.attribute.ReplaceMissingValues)
 * </pre>
 * 
 * <pre>
 * -c &lt;the class index&gt;
...
public class FilteredAssociator extends SingleAssociatorEnhancer implements
  ...
  public FilteredAssociator() {
    ...
    ((MultiFilter) m_Filter)
      .setFilters(new Filter[] { new com.weka.filters.unsupervised.attribute.ReplaceMissingValues() });
    m_ClassIndex = -1;
  }
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option(
      "\tFull class name of filter to use, followed\n"
        ...
        + "\teg: \"com.weka.filters.unsupervised.attribute.Remove -V -R 1,2\"\n"
        + "\t(default: com.weka.filters.MultiFilter with\n"
        + "\tcom.weka.filters.unsupervised.attribute.ReplaceMissingValues)", "F",
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() > 0) {
      ...
      setFilter(new com.weka.filters.supervised.attribute.Discretize());
    }
