...
package com.weka.associations;

import java.util.*;

import com.weka.core.AttributeStats;
 ...
 * 
 * <pre>
 * -N &lt;required number of rules com.output&gt;
 ...
 * <pre>
 * -I
 *  If set the itemsets found are also com.output. (default = no)
 * </pre>
 * 
 * <pre>
 * -R
...
public class Apriori extends AbstractAssociator implements OptionHandler,
  ...
  /** The maximum number of rules that are com.output. */
  ...
  public Enumeration<Option> listOptions() {
    ...
    String string1 = "\tThe required number of rules. (default = " + m_numRules
      ...
      + m_lowerBoundMinSupport + ")", string6 = "\tIf used, rules are tested for significance at\n", string7 = "\tthe given level. Slower. (default = no significance testing)", string8 = "\tIf set the itemsets found are also com.output. (default = no)", string9 = "\tIf set class association rules are mined. (default = no)", string10 = "\tThe class index. (default = last)", stringType = "\tThe metric type by which to rank rules. (default = "
  ...
  /**
   * Sets whether itemsets are com.output as well
   * 
   * @param flag true if itemsets are to be com.output as well
   */
  ...
  /**
   * Gets whether itemsets are com.output as well
   * 
   * @return true if itemsets are com.output as well
   */
  ...
  public String outputItemSetsTipText() {
    return "If enabled the itemsets are com.output as well.";
  }

  /**
   * Sets verbose mode
   * 
   * @param flag true if algorithm should be com.run in verbose mode
   */
  ...
  /**
   * Gets whether algorithm is com.run in verbose mode
   * 
   * @return true if algorithm is com.run in verbose mode
   */
  ...
  public String verboseTipText() {
    return "If enabled the algorithm will be com.run in verbose mode.";
  }
  ...
  /**
   * Gets a list of the names of the metrics com.output for each rule. This list
