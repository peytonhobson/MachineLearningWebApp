...
import static com.weka.core.WekaPackageManager.DO_NOT_LOAD_IF_CLASS_NOT_PRESENT_KEY;
import static com.weka.core.WekaPackageManager.DO_NOT_LOAD_IF_ENV_VAR_NOT_SET_KEY;
import static com.weka.core.WekaPackageManager.DO_NOT_LOAD_IF_ENV_VAR_NOT_SET_MESSAGE_KEY;
import static com.weka.core.WekaPackageManager.DO_NOT_LOAD_IF_FILE_NOT_PRESENT_KEY;
import static com.weka.core.WekaPackageManager.DO_NOT_LOAD_IF_FILE_NOT_PRESENT_MESSAGE_KEY;
 ...
 * classloader) - covers general stuff and com.weka core classes. Next tries the
...
public class WekaPackageLibIsolatingClassLoader extends URLClassLoader {
  ...
  /** True to com.output debugging info */
   ...
   * com.weka core classes. Next tries the package jar files and third-party libs
