 ...
 * Weka classes:
 * <ul>
 * <li>com.weka.core.Matrix</li>
 * <li>com.weka.core.matrix.Matrix</li>
 * </ul>
 * 
...
public class XMLBasicSerialization extends XMLSerialization {
  ...
  public void clear() throws Exception {
    ...
    // Weka classes
    m_CustomMethods.register(this, com.weka.core.matrix.Matrix.class, "Matrix");
    m_CustomMethods.register(this, com.weka.core.Matrix.class, "MatrixOld");
    m_CustomMethods.register(this, com.weka.classifiers.CostMatrix.class,
      "CostMatrix");
  }
   ...
   * @return the node that was created
   * @throws Exception if the DOM creation fails
   * @see com.weka.classifiers.CostMatrix
   */
  public Element writeCostMatrix(Element parent, Object o, String name)
    throws Exception {
    com.weka.classifiers.CostMatrix matrix = (com.weka.classifiers.CostMatrix) o;
    Element node;
  ...
  public Object readCostMatrix(Element node) throws Exception {
    com.weka.classifiers.CostMatrix matrix;
    Vector<Element> children;
    Element child;
    int i;
    String name;
    ...
    for (i = 0; i < children.size(); i++) {
      ...
      if (name.equals(VAL_CELLS)) {
        ...
        Object[][] m = (Object[][]) o;
        matrix = new com.weka.classifiers.CostMatrix(m.length);
        for (int j = 0; j < matrix.size(); j++) {
   ...
   * @return the node that was created
   * @throws Exception if the DOM creation fails
   * @see com.weka.core.matrix.Matrix
   */
  public Element writeMatrix(Element parent, Object o, String name)
    throws Exception {

    com.weka.core.matrix.Matrix matrix;
    Element node;
    ...
    matrix = (com.weka.core.matrix.Matrix) o;
    node = addElement(parent, name, o.getClass().getName(), false);
  ...
  public Object readMatrix(Element node) throws Exception {
    ...
    for (i = 0; i < children.size(); i++) {
      ...
      if (name.equals(VAL_CELLS)) {
        o = invokeReadFromXML(child);
        matrix = new com.weka.core.matrix.Matrix((double[][]) o);
      }
    }
  ...
  public Object readMatrixOld(Element node) throws Exception {
    com.weka.core.Matrix matrix;
    com.weka.core.matrix.Matrix matrixNew;
    ...
    matrixNew = (com.weka.core.matrix.Matrix) readMatrix(node);
    matrix = new com.weka.core.Matrix(matrixNew.getArrayCopy());
  ...
  public Object readCostMatrixOld(Element node) throws Exception {
    ...
    matrix =
      new com.weka.classifiers.CostMatrix(new StringReader(writer.toString()));
