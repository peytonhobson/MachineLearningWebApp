...
import com.weka.core.json.JSONInstances;
...
public class JSONSaver extends AbstractFileSaver implements BatchConverter, WeightedInstancesHandler {
  ...
  /** whether to compress the com.output. */
  ...
  public String compressOutputTipText() {
    return "Optional compression of the com.output data";
  }

  /**
   * Gets whether the com.output data is compressed.
   * 
   * @return true if the com.output data is compressed
   */
  ...
  /**
   * Sets whether to compress the com.output.
   * 
   * @param value if truee the com.output will be compressed
   */
