...
/** 
 * Interface to something that can save Instances to an com.output destination in some
 * format.
 *
...
public interface Saver
  ...
  /** Sets the com.output file
   * @param file the com.output file
   * @throws IOException exception if new com.output file cannot be set
   */  
  ...
  /** Sets the directory of the com.output file.
   * This method is used in the KnowledgeFlow GUI.
  ...
  /** Gets the driectory of the com.output file
   * This method is used in the KnowledgeFlow GUI.
   ...
   * @param inst the instance to write, if null the com.output file is closed
