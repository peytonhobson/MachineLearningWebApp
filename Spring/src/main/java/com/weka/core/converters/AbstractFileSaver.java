 ...
 * <p>
 * 
 * -o the com.output file <br>
 * The com.output file. The prefix of the com.output file is sufficient. If no com.output
...
public abstract class AbstractFileSaver extends AbstractSaver implements
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option("\tThe com.output file", "o", 1,
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (outputString.length() != 0) {
      ...
      try {
        ...
        throw new IOException("Cannot create com.output file (Reason: "
  ...
  public void setDestination(File file) throws IOException {
    ...
    if (m_outputFile != null) {
      try {
        ...
        throw new IOException("Cannot create a new com.output file (Reason: "
          + ex.toString() + "). Standard out is used.");
      } finally {
        if (!success) {
          System.err
            .println("Cannot create a new com.output file. Standard out is used.");
  ...
  /**
   * Sets the destination com.output stream.
   * 
   * @param output the com.output stream.
  ...
  /**
   * generates a string suitable for com.output on the command line displaying all
   * available options.
   * 
   ...
   * 
   * @param saver the saver to com.run
