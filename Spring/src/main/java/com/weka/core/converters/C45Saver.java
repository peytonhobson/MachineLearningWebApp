...
public class C45Saver extends AbstractFileSaver implements BatchConverter,
  ...
  public void writeIncremental(Instance inst) throws IOException {
    ...
    if (retrieveFile() == null || getWriter() == null) {
      throw new IOException(
        "C4.5 format requires two files. Therefore no com.output to standard out can be generated.\nPlease specifiy com.output files using the -o option.");
    }
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (outputString.length() != 0) {
      ...
      try {
        ...
        throw new IOException("Cannot create com.output file.");
      }
    }
