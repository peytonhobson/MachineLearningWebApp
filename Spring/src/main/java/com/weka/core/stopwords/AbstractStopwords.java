...
package com.weka.core.stopwords;
...
public abstract class AbstractStopwords
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option(
      "\tIf set, stopword scheme is com.run in debug mode and\n"
  ...
  public String debugTipText() {
    return "If set to true, stopwords scheme may com.output additional info to "
      + "the console.";
  }
   ...
   *
   * @param msg		the message to com.output
   */
