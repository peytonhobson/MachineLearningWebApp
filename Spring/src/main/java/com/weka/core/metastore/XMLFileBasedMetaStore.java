...
package com.weka.core.metastore;

import com.weka.core.ResourceUtils;
    ...
    try {
      XMLBasicSerialization ser = new XMLBasicSerialization() {
        public void clear() throws Exception {
          ...
          m_Properties.addAllowed(com.weka.associations.Associator.class,
            "options");
          ...
          m_Properties.addAllowed(com.weka.attributeSelection.ASSearch.class,
            "options");
          m_Properties.addAllowed(com.weka.attributeSelection.ASEvaluation.class,
            "options");

          m_Properties.addAllowed(com.weka.core.converters.DatabaseSaver.class,
            "options");
          m_Properties.addAllowed(com.weka.core.converters.DatabaseLoader.class,
            "options");
          m_Properties.addAllowed(
            com.weka.core.converters.TextDirectoryLoader.class, "options");

          // we assume that classes implementing SplitEvaluator also implement
          // OptionHandler
          m_Properties.addAllowed(com.weka.experiment.SplitEvaluator.class,
            "options");
          // we assume that classes implementing ResultProducer also implement
          // OptionHandler
          m_Properties.addAllowed(com.weka.experiment.ResultProducer.class,
            "options");
