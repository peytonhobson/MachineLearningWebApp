...
public class GreedyStepwise extends ASSearch implements RankedOutputSearch,
  ...
  /**
   * Set whether to com.output debugging info to the console
   * 
   * @param d true if dubugging info is to be com.output
   */
  ...
  /**
   * Get whether to com.output debugging info to the console
   * 
   * @return true if dubugging info is to be com.output
   */
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option("\tPrint debugging com.output", "D", 0, "-D"));
  ...
  public int[] search(ASEvaluation ASEval, Instances data) throws Exception {
    ...
    if (data != null) { // this is a fresh com.run so reset
      resetOptions();
        ...
        if (z) {
          ...
          if (parallel) {
            ...
            final SubsetEvaluator theEvaluator =
              (ASEvaluator instanceof com.weka.core.ThreadSafe) ? ASEvaluator
