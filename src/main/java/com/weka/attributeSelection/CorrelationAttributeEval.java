...
public class CorrelationAttributeEval extends ASEvaluation implements
  ...
  /** Whether to com.output detailed (per value) correlation for nominal attributes */
  protected boolean m_detailedOutput = false;

  /** Holds the detailed com.output info */
  ...
  /**
   * Set whether to com.output per-value correlation for nominal attributes
   * 
   * @param d true if detailed (per-value) correlation is to be com.output for
   *          nominal attributes
   */
  ...
  /**
   * Get whether to com.output per-value correlation for nominal attributes
   * 
   * @return true if detailed (per-value) correlation is to be com.output for
   *         nominal attributes
   */
  ...
  public String toString() {
    ...
    if (m_correlations == null) {
      ...
      if (m_detailedOutput && m_detailedOutputBuff.length() > 0) {
        buff.append("\n\tDetailed com.output for nominal attributes");
