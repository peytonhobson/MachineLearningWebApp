 ...
 * (default: com.weka.filters.AllFilter)
 * </pre>
 * 
 * <pre>
 * -W
 ...
 * @version $Revision$
 * @see com.weka.classifiers.meta.FilteredClassifier
 */
public class FilteredClusterer extends SingleClustererEnhancer implements Drawable {
  ...
  public FilteredClusterer() {
    ...
    m_Filter = new com.weka.filters.AllFilter();
  }
  ...
  protected String defaultFilterString() {
    return com.weka.filters.AllFilter.class.getName();
  }
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (tmpStr.length() > 0) {
      ...
      setFilter(new com.weka.filters.AllFilter());
    }
