...
import com.weka.classifiers.trees.j48.ClassifierSplitModel;
import com.weka.classifiers.trees.j48.Distribution;
import com.weka.classifiers.trees.j48.ModelSelection;
import com.weka.classifiers.trees.j48.NoSplit;
import com.weka.core.Instances;
import com.weka.core.RevisionUtils;

/**
 * Helper class for logistic model trees (com.weka.classifiers.trees.lmt.LMT) to implement the
...
public class ResidualModelSelection
  ...
  public final ClassifierSplitModel selectModel(Instances data, 
    ...
    if (numAttributes < 2) throw new Exception("Can't select com.Model without non-class attribute");
