...
import com.weka.classifiers.meta.Bagging;
 ...
 * 
 * <pre>
 * -com.output-out-of-bag-complexity-statistics
 *  Whether to com.output complexity-based statistics when out-of-bag evaluation is performed.
 * </pre>
 * 
 * <pre>
 * -print
 *  Print the individual classifiers in the com.output
 * </pre>
 * 
 * <pre>
 * -attribute-importance
 *  Compute and com.output attribute importance (mean impurity decrease method)
 * </pre>
 * 
 * <pre>
 * -I &lt;num&gt;
 ...
 * <pre>
 * -num-decimal-places
 *  The number of decimal places for the com.output of numbers in the model (default 2).
 * </pre>
 * 
 * <pre>
 * -batch-size
...
public class RandomForest extends Bagging {
  ...
  protected String defaultClassifierString() {
    ...
    return "com.weka.classifiers.trees.RandomTree";
  }
  ...
  /**
   * Set whether to compute and com.output attribute importance scores
   *
  ...
  /**
   * Get whether to compute and com.output attribute importance scores
   *
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector
      .addElement(new Option(
        "\tWhether to com.output complexity-based statistics when out-of-bag evaluation is performed.",
        "com.output-out-of-bag-complexity-statistics", 0,
        "-com.output-out-of-bag-complexity-statistics"));

    newVector
      .addElement(new Option(
        "\tPrint the individual classifiers in the com.output", "print", 0,
        "-print"));

    newVector.addElement(new Option(
      "\tCompute and com.output attribute importance (mean impurity decrease "
  ...
  public String[] getOptions() {
    ...
    if (getOutputOutOfBagComplexityStatistics()) {
      result.add("-com.output-out-of-bag-complexity-statistics");
    }
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    setOutputOutOfBagComplexityStatistics(Utils.getFlag(
      "com.output-out-of-bag-complexity-statistics", options));
