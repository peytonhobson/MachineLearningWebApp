...
import com.weka.classifiers.trees.j48.C45ModelSelection;
import com.weka.classifiers.trees.j48.ModelSelection;
import com.weka.classifiers.trees.lmt.LMTNode;
import com.weka.classifiers.trees.lmt.ResidualModelSelection;
...
import com.weka.filters.supervised.attribute.NominalToBinary;
 ...
 * <br/>
 * Niels Landwehr, Mark Hall, Eibe Frank (2005). Logistic com.Model Trees. Machine
 * Learning. 95(1-2):161-205.<br/>
 * <br/>
 * Marc Sumner, Eibe Frank, Mark Hall: Speeding up Logistic com.Model Tree
 ...
 *    number = {1-2},
 *    pages = {161-205},
 *    title = {Logistic com.Model Trees},
 *    volume = {95},
 *    year = {2005}
 * }
 * 
 ...
 *    pages = {675-683},
 *    publisher = {Springer},
 *    title = {Speeding up Logistic com.Model Tree Induction},
 *    year = {2005}
 * }
 * </pre>
 * <p/>
...
public class LMT extends AbstractClassifier implements OptionHandler,
  ...
  public TechnicalInformation getTechnicalInformation() {
    ...
    result.setValue(Field.TITLE, "Logistic com.Model Trees");
    ...
    additional.setValue(Field.TITLE,
      "Speeding up Logistic com.Model Tree Induction");
    additional
      .setValue(
        Field.BOOKTITLE,
  ...
  public String fastRegressionTipText() {
    return "Use heuristic that avoids cross-validating the number of Logit-Boost iterations at every node. "
      ...
      + "iterations to com.run. Originally, this number was cross-validated at every node in the tree. "
  ...
  public String numDecimalPlacesTipText() {
    return "The number of decimal places to be used for the com.output of coefficients.";
  }
