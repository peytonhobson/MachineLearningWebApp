...
import com.weka.core.pmml.PMMLUtils;
...
public class GeneralRegression extends PMMLClassifier
  ...
  enum CumulativeLinkFunction {
    ...
    PROBIT ("probit") {
      double eval(double value, double offset) {
        return com.weka.core.matrix.Maths.pnorm(value + offset);
      }
    },
    CLOGLOG ("cloglog") {
      double eval(double value, double offset) {
  ...
  enum LinkFunction {
    ...
    PROBIT ("probit") {
      double eval(double value, double offset, double trials,
                  double distParam, double linkParam) {
        return com.weka.core.matrix.Maths.pnorm(value + offset) * trials;
      }
    };
