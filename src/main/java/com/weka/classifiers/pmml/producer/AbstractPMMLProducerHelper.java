...
import com.weka.core.pmml.jaxbbindings.Application;
import com.weka.core.pmml.jaxbbindings.DataDictionary;
import com.weka.core.pmml.jaxbbindings.DataField;
import com.weka.core.pmml.jaxbbindings.Header;
import com.weka.core.pmml.jaxbbindings.OPTYPE;
import com.weka.core.pmml.jaxbbindings.PMML;
import com.weka.core.pmml.jaxbbindings.Value;
...
public abstract class AbstractPMMLProducerHelper {
  ...
  /**
   * Returns an OPTYPE for a com.weka attribute type. Note that PMML only supports
   * categorical, continuous and ordinal types.
   * 
   * @param wekaType the type of the com.weka attribute
