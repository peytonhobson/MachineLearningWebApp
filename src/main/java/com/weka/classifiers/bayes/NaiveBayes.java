...
import com.weka.estimators.KernelEstimator;
import com.weka.estimators.NormalEstimator;
...
public class NaiveBayes extends AbstractClassifier implements OptionHandler,
   ...
   */
  protected com.weka.filters.supervised.attribute.Discretize m_Disc = null;
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_UseDiscretization) {
      m_Disc = new com.weka.filters.supervised.attribute.Discretize();
      m_Disc.setInputFormat(m_Instances);
      m_Instances = com.weka.filters.Filter.useFilter(m_Instances, m_Disc);
    } else {
      m_Disc = null;
    }
