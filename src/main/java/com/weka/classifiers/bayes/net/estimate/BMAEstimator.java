...
package com.weka.classifiers.bayes.net.estimate;
 ...
 * tables of a Bayes network using Bayes com.Model Averaging (BMA).
 * <p/>
 * <!-- globalinfo-end -->
 * 
...
public class BMAEstimator extends SimpleEstimator {
  ...
  public String globalInfo() {
    return "BMAEstimator estimates conditional probability tables of a Bayes "
      + "network using Bayes com.Model Averaging (BMA).";
  }
