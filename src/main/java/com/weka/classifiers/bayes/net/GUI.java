 ...
 *
 */
package com.weka.classifiers.bayes.net;

import com.weka.classifiers.bayes.net.MarginCalculator.JunctionTreeNode;
...
import com.weka.gui.graphvisualizer.BIFParser;
import com.weka.gui.graphvisualizer.GraphEdge;
import com.weka.gui.graphvisualizer.GraphNode;
import com.weka.gui.graphvisualizer.HierarchicalBCEngine;
import com.weka.gui.graphvisualizer.LayoutCompleteEvent;
import com.weka.gui.graphvisualizer.LayoutCompleteEventListener;
import com.weka.gui.graphvisualizer.LayoutEngine;
...
public class GUI extends JPanel implements LayoutCompleteEventListener {
  ...
  class MyAction extends AbstractAction {
    ...
    public MyAction(String sName, String sToolTipText, String sIcon,
      ...
      if (tempURL != null) {
        ...
        // ".png not found for com.weka.gui.graphvisualizer.Graph");
      }
    } // c'tor
  ...
  /**
   * Table com.Model for the Table for editing CPTs
   */
