 ...
 * 
 */
package com.weka.classifiers.bayes;
...
import com.weka.classifiers.bayes.net.ADNode;
import com.weka.classifiers.bayes.net.BIFReader;
import com.weka.classifiers.bayes.net.ParentSet;
import com.weka.classifiers.bayes.net.estimate.BayesNetEstimator;
import com.weka.classifiers.bayes.net.estimate.DiscreteEstimatorBayes;
import com.weka.classifiers.bayes.net.estimate.SimpleEstimator;
import com.weka.classifiers.bayes.net.search.SearchAlgorithm;
import com.weka.classifiers.bayes.net.search.local.K2;
import com.weka.classifiers.bayes.net.search.local.LocalScoreSearchAlgorithm;
import com.weka.classifiers.bayes.net.search.local.Scoreable;
...
import com.weka.estimators.Estimator;
import com.weka.filters.Filter;
import com.weka.filters.supervised.attribute.Discretize;
 ...
 * 
 * <pre>
 * -Q com.weka.classifiers.bayes.net.search.SearchAlgorithm
 *  Search algorithm
 * </pre>
 * 
 * <pre>
 * -E com.weka.classifiers.bayes.net.estimate.SimpleEstimator
 *  Estimator algorithm
 * </pre>
 * 
 * <!-- options-end -->
...
public class BayesNet extends AbstractClassifier implements OptionHandler,
  ...
  public String useADTreeTipText() {
    return "When ADTree (the data structure for increasing speed on counts,"
      ...
      + " the structure learning algorithms slower, and com.run with less memory."
