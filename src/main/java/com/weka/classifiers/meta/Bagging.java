...
package com.weka.classifiers.meta;
...
import com.weka.classifiers.RandomizableParallelIteratedSingleClassifierEnhancer;
import com.weka.classifiers.evaluation.Evaluation;
 ...
 *
 * <pre> -print
 *  Print the individual classifiers in the com.output</pre>
 *
 * <pre> -store-out-of-bag-predictions
 *  Whether to store out of bag predictions in internal evaluation object.</pre>
 *
 * <pre> -com.output-out-of-bag-complexity-statistics
 *  Whether to com.output complexity-based statistics when out-of-bag evaluation is performed.</pre>
 *
 ...
 *  (default: com.weka.classifiers.trees.REPTree)</pre>
 * 
 * <pre> 
 * Options specific to classifier com.weka.classifiers.trees.REPTree:
 * </pre>
 * 
...
public class Bagging
  ...
  /** Whether to com.output complexity-based statistics when OOB-evaluation is performed. */
  private boolean m_OutputOutOfBagComplexityStatistics;

  /** Whether class is numeric. */
  private boolean m_Numeric = false;

  /** Whether to print individual ensemble members in com.output.*/
  ...
  public Bagging() {
    ...
    m_Classifier = new com.weka.classifiers.trees.REPTree();
  }
  ...
  protected String defaultClassifierString() {
    ...
    return "com.weka.classifiers.trees.REPTree";
  }
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
              "\tWhether to com.output complexity-based statistics when out-of-bag evaluation is performed.",
              "com.output-out-of-bag-complexity-statistics", 0, "-com.output-out-of-bag-complexity-statistics"));
    newVector.addElement(new Option(
    ...
    newVector.addElement(new Option(
              "\tPrint the individual classifiers in the com.output", "print", 0, "-print"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    setOutputOutOfBagComplexityStatistics(Utils.getFlag("com.output-out-of-bag-complexity-statistics", options));
  ...
  public String [] getOptions() {
    ...
    if (getOutputOutOfBagComplexityStatistics()) {
        options.add("-com.output-out-of-bag-complexity-statistics");
    }
  ...
  public String outputOutOfBagComplexityStatisticsTipText() {
    ...
    return "Whether to com.output complexity-based statistics when out-of-bag evaluation is performed.";
  }

  /**
   * Gets whether complexity statistics are com.output when OOB estimation is performed.
   *
  ...
  /**
   * Sets whether complexity statistics are com.output when OOB estimation is performed.
   *
  ...
  public String printClassifiersTipText() {
    return "Print the individual classifiers in the com.output";
  }

  /**
   * Set whether to print the individual ensemble classifiers in the com.output
   *
  ...
  /**
   * Get whether to print the individual ensemble classifiers in the com.output
   *
