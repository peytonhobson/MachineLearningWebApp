...
import com.weka.classifiers.RandomizableSingleClassifierEnhancer;
import com.weka.core.*;
import com.weka.core.Capabilities.Capability;
import com.weka.filters.Filter;
import com.weka.filters.supervised.attribute.AttributeSelection;
import com.weka.filters.unsupervised.attribute.Reorder;
 ...
 *  by filter options.
 *  default: "com.weka.filters.supervised.attribute.Discretize -R first-last -precision 6"
 * </pre>
 *
 * <pre>
 * -W &lt;classifier name&gt;
 *  Full name of base classifier.
 *  (default: com.weka.classifiers.trees.J48)
 * </pre>
 *
 * <pre> -S num
...
public class FilteredClassifier extends RandomizableSingleClassifierEnhancer
  ...
  protected String defaultFilterString() {
    ...
    return "com.weka.filters.supervised.attribute.Discretize -R first-last -precision 6";
  }
  ...
  public FilteredClassifier() {
    ...
    m_Filter = new com.weka.filters.supervised.attribute.Discretize();
  }
  ...
  protected Instance filterInstance(Instance instance) throws Exception {
    ...
    if (m_Filter.numPendingOutput() > 0) {
      throw new Exception("Filter com.output queue not empty!");
    }
    /*
     * String fname = m_Filter.getClass().getName(); fname =
     * fname.substring(fname.lastIndexOf('.') + 1); util.Timer t =
