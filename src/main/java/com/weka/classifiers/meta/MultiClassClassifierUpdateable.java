...
/**
 <!-- globalinfo-start -->
 * A metaclassifier for handling multi-class datasets with 2-class classifiers. This classifier is also capable of applying error correcting com.output codes for increased accuracy. The base classifier must be an updateable classifier
 * <p/>
 <!-- globalinfo-end -->
 * 
 <!-- options-start -->
 ...
 *  (default: com.weka.classifiers.functions.SGD)</pre>
 * 
 <!-- options-end -->
 * 
...
public class MultiClassClassifierUpdateable extends MultiClassClassifier
  ...
  public MultiClassClassifierUpdateable() {
    m_Classifier = new com.weka.classifiers.functions.SGD();
  }
