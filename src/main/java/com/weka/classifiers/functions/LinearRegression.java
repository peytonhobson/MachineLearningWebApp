...
import com.weka.classifiers.evaluation.RegressionAnalysis;
 ...
 *  com.Model cannot be printed out if this option is enabled. (default: keep data)
 * </pre>
 * 
 * <pre>
 * -additional-stats
...
public class LinearRegression extends AbstractClassifier implements
  ...
  /**
   * Whether to com.output additional statistics such as std. dev. of coefficients
   * and t-stats
   */
  ...
  public String toString() {
    ...
    if (m_Minimal) {
      return "Linear Regression: com.Model built.";
    }
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
      "\tConserve memory, don't keep dataset header and means/stdevs.\n"
        + "\tcom.Model cannot be printed out if this option is enabled."
  ...
  /**
   * Returns whether to be more memory conservative or being able to com.output the
   * model as string.
   * 
  ...
  /**
   * Sets whether to be more memory conservative or being able to com.output the
   * model as string.
   *
  ...
  /**
   * Get whether to com.output additional statistics (such as std. deviation of
   * coefficients and t-statistics
   * 
   * @return true if additional stats are to be com.output
   */
  ...
  /**
   * Set whether to com.output additional statistics (such as std. deviation of
   * coefficients and t-statistics
   *
   * @param additional true if additional stats are to be com.output
   */
