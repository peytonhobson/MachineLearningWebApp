...
import com.weka.core.pmml.PMMLProducer;
import com.weka.filters.Filter;
import com.weka.filters.unsupervised.attribute.NominalToBinary;
import com.weka.filters.unsupervised.attribute.RemoveUseless;
 ...
 * com.weka.core.Optimization class.<br/>
 * <br/>
...
public class Logistic extends AbstractClassifier implements OptionHandler,
  ...
  public String globalInfo() {
    return "Class for building and using a multinomial logistic "
      ...
      + "com.weka.core.Optimization class.\n\n"
  ...
  /**
   * Sets whether debugging com.output will be printed.
   * 
   * @param debug true if debugging com.output should be printed
   */
  @Override
  ...
  /**
   * Gets whether debugging com.output will be printed.
   * 
   * @return true if debugging com.output will be printed
   */
  @Override
