...
package com.weka.classifiers.misc;
...
import com.weka.classifiers.SingleClassifierEnhancer;
 ...
 * com.Model attributes that are not found in the incoming instances receive missing
 ...
 * <pre>
 * -M
 *  Suppress the com.output of the mapping report.
 * </pre>
 * 
 * <pre>
 * -trim
 ...
 *  (default: com.weka.classifiers.rules.ZeroR)
 * </pre>
 * 
 * <pre>
...
public class InputMappedClassifier extends SingleClassifierEnhancer implements
  ...
  /** Dont com.output mapping report if set to true */
   ...
   * is useful for getting a correct mapping report com.output in toString() after
  ...
  public String globalInfo() {
    return "Wrapper classifier that addresses incompatible training and test "
      ...
      + "structure. com.Model attributes that are not found in the incoming "
  ...
  public String suppressMappingReportTipText() {
    return "Don't com.output a report of model-to-input mappings.";
  }

  /**
   * Set whether to suppress com.output the report of model to input mappings.
   * 
   * @param suppress true to suppress this com.output.
   */
  ...
  /**
   * Get whether to suppress com.output the report of model to input mappings.
   * 
   * @return true if this com.output is to be suppressed.
   */
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector.addElement(new Option(
      "\tSuppress the com.output of the mapping report.", "M", 0, "-M"));
    newVector.addElement(new Option(
      "\tTrim white space from either end of names " + "before matching.",
      "trim", 0, "-trim"));
    newVector.addElement(new Option(
   ...
   * for getting a correct mapping report com.output in toString() after
   * buildClassifier has been called and before any test instance has been seen.
   * Test structure and mapping will get reset if a test instance is received
   * whose structure does not match the recorded test structure.
   * 
  ...
  private StringBuffer createMappingReport() {
    ...
    int minLength = 16;
    String headerS = "com.Model attributes";
    String sep = "----------------";
  ...
  public synchronized Instance constructMappedInstance(Instance incoming) throws Exception {
    ...
    if (m_inputHeader == null) {
       ...
       * Instances(m_inputHeader, 0)); System.out.println("com.Model header\n" + new
  ...
  public String toString() {
    ...
    if (m_modelPath != null && m_modelPath.length() > 0) {
      buff.append("com.Model sourced from: " + m_modelPath + "\n\n");
    }
