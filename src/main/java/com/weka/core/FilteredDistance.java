...
import com.weka.core.neighboursearch.PerformanceStats;

import com.weka.filters.Filter;
import com.weka.filters.unsupervised.attribute.RandomProjection;
 ...
 *
 ...
 <pre> -F
  The filter to use. (default: com.weka.unsupervised.attribute.RandomProjection</pre>
 
 <pre> -E
  The distance function to use. (default: com.weka.core.EuclideanDistance</pre>
 
 <pre> 
 Options specific to filter com.weka.filters.unsupervised.attribute.RandomProjection:
 </pre>
 ...
 <pre> 
 Options specific to distance function com.weka.core.EuclideanDistance:
 </pre>
...
public class FilteredDistance implements DistanceFunction, OptionHandler, Serializable {
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.add(new Option("\tThe filter to use. (default: com.weka.unsupervised.attribute.RandomProjection",
      "F", 1, "-F"));

    result.addElement(new Option("\tThe distance function to use. (default: com.weka.core.EuclideanDistance",
      "E", 0, "-E"));
