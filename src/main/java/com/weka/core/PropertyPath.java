...
public class PropertyPath
  ...
  public static void main(String[] args) throws Exception {
    ...
    com.weka.classifiers.meta.Vote vote = new com.weka.classifiers.meta.Vote();
    vote.setClassifiers(
	new com.weka.classifiers.Classifier[]{
	    new com.weka.classifiers.trees.J48(),
	    new com.weka.classifiers.functions.LinearRegression()});
