...
package com.weka.core.converters;
...
public class ConverterResources {
   ...
   */
  public final static String CORE_FILE_LOADERS = com.weka.core.converters.ArffLoader.class
    .getName()
    + ","
    // + com.weka.core.converters.C45Loader.class.getName() + ","
    + com.weka.core.converters.CSVLoader.class.getName()
    + ","
    + com.weka.core.converters.DatabaseConverter.class.getName()
    + ","
    // + com.weka.core.converters.LibSVMLoader.class.getName() + ","
    // + com.weka.core.converters.MatlabLoader.class.getName() + ","
    // + com.weka.core.converters.SVMLightLoader.class.getName() + ","
    + com.weka.core.converters.SerializedInstancesLoader.class.getName()
    + ","
    + com.weka.core.converters.TextDirectoryLoader.class.getName()
    + ","
    + com.weka.core.converters.XRFFLoader.class.getName();

  /**
   * the core savers - hardcoded list necessary for RMI/Remote Experiments
   * (comma-separated list).
   */
  public final static String CORE_FILE_SAVERS = com.weka.core.converters.ArffSaver.class
    .getName()
    + ","
    // + com.weka.core.converters.C45Saver.class.getName() + ","
    + com.weka.core.converters.CSVSaver.class.getName()
    + ","
    + com.weka.core.converters.DatabaseConverter.class.getName()
    + ","
    // + com.weka.core.converters.LibSVMSaver.class.getName() + ","
    // + com.weka.core.converters.MatlabSaver.class.getName() + ","
    // + com.weka.core.converters.SVMLightSaver.class.getName() + ","
    + com.weka.core.converters.SerializedInstancesSaver.class.getName()
    + ","
    + com.weka.core.converters.XRFFSaver.class.getName();
