 ...
 */
package com.weka.core.neighboursearch;
...
import com.weka.filters.unsupervised.attribute.AddID;
 ...
 * 
 * <pre> -F
 *  The filter to use. (default: com.weka.filters.AllFilter)</pre>
 * 
 * <pre> -S
 *  The search method to use. (default: com.weka.core.neighboursearch.LinearNNSearch)</pre>
 * 
 * <pre> 
 * Options specific to filter com.weka.filters.AllFilter:
 * </pre>
 * 
 ...
 * 
 * <pre> 
 * Options specific to search method com.weka.core.neighboursearch.LinearNNSearch:
 * </pre>
 * 
 * <pre> -S
 ...
 *  (default: com.weka.core.EuclideanDistance)</pre>
 * 
 * <pre> -P
...
public class FilteredNeighbourSearch extends NearestNeighbourSearch implements CapabilitiesHandler {
  ...
  public Enumeration<Option> listOptions() {
    ...
    result
      .add(new Option(
        "\tThe filter to use. (default: com.weka.filters.AllFilter",
        "F", 1, "-F"));

    result
      .addElement(new Option(
        "\tThe search method to use. (default: com.weka.core.neighboursearch.LinearNNSearch)",
        "S", 0, "-S"));
   ...
   * @return the revision
   * 
   * @see com.weka.core.RevisionHandler#getRevision()
   */
  @Override
   ...
   * 
   * @see com.weka.core.neighboursearch.NearestNeighbourSearch#nearestNeighbour(com.weka.core.Instance)
   */
  @Override
   ...
   * 
   * @see com.weka.core.neighboursearch.NearestNeighbourSearch#kNearestNeighbours(com.weka.core.Instance,
   *      int)
   */
  @Override
   ...
   * 
   * @see com.weka.core.neighboursearch.NearestNeighbourSearch#getDistances()
   */
  @Override
   ...
   * 
   * @see com.weka.core.neighboursearch.NearestNeighbourSearch#update(com.weka.core.Instance)
   */
  @Override
