...
public class Discretize extends Expression {
  ...
  /** The com.output structure of this discretization */
  ...
  private void setUpField() throws Exception {
    ...
    // set up the com.output structure
  ...
  protected Attribute getOutputDef() {
    if (m_outputDef == null) {
      // return a "default" com.output def. This will get replaced
   ...
   * (non-Javadoc)
   * 
   * @see com.weka.core.pmml.Expression#toString(java.lang.String)
   */
  @Override
