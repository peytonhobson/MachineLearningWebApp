...
public abstract class Logger implements RevisionHandler {
  ...
  protected static String[] getLocation() {
    ...
    for (i = 0; i < trace.length; i++) {
      ...
      if (trace[i].getClassName().equals(com.weka.gui.LogPanel.class.getName()))
        continue;
  ...
  public static Logger getSingleton() {
    ...
    if (m_Singleton == null) {
      // logger
      classname =
        m_Properties.getProperty("com.weka.core.logging.Logger",
      ...
      m_DateFormat =
        new SimpleDateFormat(m_Properties.getProperty(
          "com.weka.core.logging.DateFormat", "yyyy-MM-dd HH:mm:ss"));
    }
  ...
  protected void initialize() {
    m_MinLevel =
      Level.valueOf(m_Properties.getProperty("com.weka.core.logging.MinLevel",
        "INFO"));
  }
