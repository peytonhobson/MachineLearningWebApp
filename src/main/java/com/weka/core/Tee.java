...
public class Tee
  ...
  /**
   * Writes <code>b.length</code> bytes to this com.output stream.
   * <p>
   ...
   * <code>write</code> method of its underlying com.output stream with
  ...
  /**
   * A convenience method to write a formatted string to this com.output stream
  ...
  /**
   * Appends the specified character to this com.output stream.
   *
  ...
  /**
   * Appends the specified character sequence to this com.output stream.
   *
   ...
   *         appended to this com.output stream.
   *
   * @return  This com.output stream
   *
   * @since  1.5
  ...
  /**
   * Appends a subsequence of the specified character sequence to this com.output
   * stream.
   *
   * <p> An invocation of this method of the form
