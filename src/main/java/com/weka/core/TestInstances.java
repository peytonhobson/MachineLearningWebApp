 ...
 * <pre>
 * -class-type &lt;num&gt;
 *  The class type, see constants in com.weka.core.Attribute
 *  (default 1=nominal).
 * </pre>
 * 
 * <pre>
 ...
 * <pre>
 * -no-class
 *  Doesn't include a class attribute in the com.output.
 * </pre>
 * 
 * <pre>
 * -nominal &lt;num&gt;
 ...
 * @version $Revision$
 * @see com.weka.classifiers.CheckClassifier
 */
public class TestInstances implements Cloneable, Serializable, OptionHandler,
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.add(new Option("\tDoesn't include a class attribute in the com.output.",
      "no-class", 0, "-no-class"));
