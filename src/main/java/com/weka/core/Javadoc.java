...
public abstract class Javadoc implements OptionHandler, RevisionHandler {
  ...
  /**
   * sets whether to suppress com.output in the console
   * 
   * @param value true if com.output is to be suppressed
   */
  ...
  /**
   * whether com.output in the console is suppressed
   * 
   * @return true if com.output is suppressed
   */
