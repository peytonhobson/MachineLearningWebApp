...
/**
 * A helper class for debug com.output, logging, clocking, etc.
 * 
...
public class Debug
  ...
  public static class Clock 
    ...
    /** the com.output format in milli-seconds */
    public final static int FORMAT_MILLISECONDS = 0;
    
    /** the com.output format in seconds, with fraction of msecs */
    public final static int FORMAT_SECONDS = 1;
    
    /** the com.output format in hours:minutes:seconds, with fraction of msecs */
    public final static int FORMAT_HHMMSS = 2;
    
    /** the com.output formats */
    ...
    /**
     * automatically starts the clock with the given com.output format and CPU
     * time if available
     * 
     * @param format	the com.output format
     * @see		#m_OutputFormat
     */
     ...
     * FORMAT_SECONDS com.output format and CPU time if available
     * 
    ...
    /**
     * sets the format of the com.output
     * 
     * @param value       the format of the com.output
     * @see               #m_OutputFormat
     */
  ...
  public static class Timestamp
    ...
    /** handles the format of the com.output */
  ...
  public static class Random
    ...
    /** whether to com.output debug information */
     ...
     * 
     * @param debug	if true, debugging com.output is enabled
     */
     ...
     * 
     * @param value	if true debugging com.output is enabled
     */
     ...
     * 
     * @return		true if debugging com.output is enabled
     */
  ...
  public static class DBO 
    ...
    /** enables/disables com.output of debug information */
     ...
     * @return return true if the com.output type is set
     */
   ...
   /**
     ...
     * 
     * @param list list of integers, all are used for an com.output type
     */
    ...
    /**
     * Gets the current com.output type selection
     *
     ...
     * helps to make debug com.output commands more visible in text
     * 
     ...
     * helps to make debug com.output commands more visible in text
     *
     * @param debugType the type of the com.output
     * @param text the text to print
     */
  ...
  /**
   * logs the com.output to the specified file (and stdout). Size is 1,000,000 bytes
   * and 1 file.
   * 
