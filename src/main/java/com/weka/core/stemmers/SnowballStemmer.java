...
package com.weka.core.stemmers;
 ...
 * props file 'com.weka/gui/GenericPropertiesCreator.props' is 'false', then the
 * property 'org.tartarus.snowball.SnowballProgram' in the
 * 'com.weka/gui/GenericObjectEditor.props' file has to be uncommented as well. If
 * necessary you have to discover and fill in the snowball stemmers manually.
 * You can use the 'com.weka.core.ClassDiscovery' for this:<br/>
 * java com.weka.core.ClassDiscovery org.tartarus.snowball.SnowballProgram
...
public class SnowballStemmer implements Stemmer, OptionHandler {
  ...
  public String globalInfo() {
    return "A wrapper class for the Snowball stemmers. Only available if the "
      ...
      + "in the props file 'com.weka/gui/GenericPropertiesCreator.props' is 'false', "
      + "then the property 'org.tartarus.snowball.SnowballProgram' in the "
      + "'com.weka/gui/GenericObjectEditor.props' file has to be uncommented "
      + "as well. If necessary you have to discover and fill in the snowball "
      + "stemmers manually. You can use the 'com.weka.core.ClassDiscovery' for this:\n"
      + "  java com.weka.core.ClassDiscovery org.tartarus.snowball.SnowballProgram org.tartarus.snowball.ext\n";
