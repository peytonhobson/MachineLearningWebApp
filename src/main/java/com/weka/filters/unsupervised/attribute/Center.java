...
public class Center 
   ...
   * training instances be read before producing com.output.
   *
   ...
   * com.output() may now be called to retrieve the filtered instances.
   *
   ...
   * added to the end of the com.output queue.
   *
