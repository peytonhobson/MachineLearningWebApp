...
import com.weka.filters.Sourcable;
 ...
 * <pre>
 * -S &lt;num&gt;
 *  The scaling factor for the com.output range.
 *  (default: 1.0)
 * </pre>
 * 
 * <pre>
 * -T &lt;num&gt;
 *  The translation of the com.output range.
 *  (default: 0.0)
 * </pre>
 * 
 * <!-- options-end -->
...
public class Normalize extends PotentialClassIgnorer implements
  ...
  /** The scaling factor of the com.output range. */
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option("\tThe scaling factor for the com.output range.\n"
      + "\t(default: 1.0)", "S", 1, "-S <num>"));

    result.addElement(new Option("\tThe translation of the com.output range.\n"
  ...
  public String scaleTipText() {
    return "The factor for scaling the com.output range (default: 1).";
  }
  ...
  public String translationTipText() {
    return "The translation of the com.output range (default: 0).";
  }
