 ...
 *  Specify list of string attributes to convert to words (as com.weka Range).
...
public class StringToWordVector extends Filter implements UnsupervisedFilter,
  ...
  /**
   * Default constructor. Targets 1000 words in the com.output.
   */
   ...
   * com.output.
   *
   * @param wordsToKeep the number of words in the com.output vector (per class if
   *          assigned).
   */
   ...
   * read before producing com.output.
   *
  ...
  public boolean batchFinished() throws Exception {
    ...
    if (!isFirstBatchDone()) {
      ...
      // push all instances into the com.output queue
  ...
  /**
   * Gets whether com.output instances contain 0 or 1 indicating word presence, or
   * word counts.
   *
   * @return true if word counts should be com.output.
   */
  ...
  /**
   * Sets whether com.output instances contain 0 or 1 indicating word presence, or
   * word counts.
   *
   * @param outputWordCounts true if word counts should be com.output.
   */
   ...
   * to attempt to keep.
   *
   * @return the target number of words in the com.output vector (per class if
   *         assigned).
   */
   ...
   * to attempt to keep.
   *
   * @param newWordsToKeep the target number of words in the com.output vector (per
   *          class if assigned).
   */
