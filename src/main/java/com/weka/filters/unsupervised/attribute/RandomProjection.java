...
public class RandomProjection extends Filter implements UnsupervisedFilter,
  ...
  /** Keeps track of com.output format if it is defined or not */
  ...
  public String replaceMissingValuesTipText() {
    ...
    return "If set the filter uses com.weka.filters.unsupervised.attribute.ReplaceMissingValues"
  ...
  public boolean setInputFormat(Instances instanceInfo) throws Exception {
    ...
    if (instanceInfo.classIndex() >= 0) {
      m_ntob = new com.weka.filters.supervised.attribute.NominalToBinary();
    } else {
      m_ntob = new com.weka.filters.unsupervised.attribute.NominalToBinary();
    }
