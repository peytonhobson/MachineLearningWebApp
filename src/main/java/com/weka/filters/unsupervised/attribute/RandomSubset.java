 ...
 * in the order in which they occur in the input data. The class attribute (if present) is always included in the com.output.
 * <p/>
 <!-- globalinfo-end -->
 * 
 <!-- options-start -->
...
public class RandomSubset extends SimpleBatchFilter
  ...
  public String globalInfo() {
    return "Chooses a random subset of non-class attributes, either an absolute number "
      ...
      + "attribute (if present) is always included in the com.output.";
  }
