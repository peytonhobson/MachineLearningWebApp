 ...
 * to call batchFinished() to make them available via com.output().</li>
...
public abstract class SimpleBatchFilter extends SimpleFilter {
   ...
   * @return true if the filtered instances may now be collected with com.output().
   * @throws IllegalStateException if no input structure has been defined
   * @throws Exception if something goes wrong
   * @see #batchFinished()
   */
  ...
  public boolean batchFinished() throws Exception {
    ...
    // directly by the input method and added to the com.output queue
