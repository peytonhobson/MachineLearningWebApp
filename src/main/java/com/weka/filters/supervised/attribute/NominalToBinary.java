...
public class NominalToBinary extends Filter implements SupervisedFilter,
  ...
  /**
   * Set the com.output format if the class is nominal.
   */
  ...
  /**
   * Set the com.output format if the class is numeric.
   */
   ...
   * instance is added to the end of the com.output queue.
   * 
