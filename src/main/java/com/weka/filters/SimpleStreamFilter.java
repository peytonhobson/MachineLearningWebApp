...
public abstract class SimpleStreamFilter extends SimpleFilter implements
  ...
  /**
   * Returns true if the com.output format is immediately available after the input
   ...
   * 
   * @return true if the com.output format is immediately available
   * @see #batchFinished()
  ...
  /**
   * In case the com.output format cannot be returned immediately, this method is
  ...
  public boolean batchFinished() throws Exception {
    ...
    // if com.output format hasn't been set yet, do it now
    if (!hasImmediateOutputFormat() && !isFirstBatchDone()) {
      setOutputFormat(inst);
    }

    // move data to the com.output
