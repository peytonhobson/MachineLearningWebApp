 ...
 * the <code>com.weka.filters.Sourcable</code> interface. It takes a filter, the
 * classname of the generated source and the dataset the source was generated
 * with as parameters and tests the com.output of the built filter against the
 * com.output of the generated source. Use option '-h' to display all available
 * commandline options.
 * 
 ...
 * @version $Revision$
 * @see com.weka.filters.Sourcable
 */
