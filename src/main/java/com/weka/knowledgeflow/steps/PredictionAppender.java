...
import com.weka.filters.unsupervised.attribute.Add;
...
public class PredictionAppender extends BaseStep {
  ...
  /** Holds structure of streaming com.output */
  protected Instances m_streamingOutputStructure;

  /** Re-usable Data object for streaming com.output */
  ...
  protected void processBatchClustererCase(Data data, Instances trainingData,
    ...
    com.weka.clusterers.Clusterer clusterer =
      (com.weka.clusterers.Clusterer) data
   ...
   * @throws WekaException if a problem occurs
   */
  protected void predictLabelClusterer(com.weka.clusterers.Clusterer clusterer,
   ...
   * @throws WekaException if a problem occurs
   */
  protected void predictLabelClassifier(com.weka.classifiers.Classifier classifier,
                                        Instance inst, Instance instOrig) throws WekaException {
  ...
  protected void predictProbabilitiesClassifier(
          com.weka.classifiers.Classifier classifier, Instance inst, Instance instOrig)
    throws WekaException {
    try {
  ...
  /**
   * Make an com.output dataset for a clusterer. Either a single attribute is added
   ...
   * @return the com.output dataset
   * @throws Exception if a problem occurs
   */
  protected Instances makeOutputDataClusterer(Instances inputData,
                                              com.weka.clusterers.Clusterer clusterer, boolean distribution,
    ...
    if (distribution) {
      for (int i = 0; i < clusterer.numberOfClusters(); i++) {
        ...
        newData = com.weka.filters.Filter.useFilter(newData, addF);
      }
    } else {
      Add addF = new Add();
      addF.setAttributeIndex("last");
  ...
  /**
   * Make an com.output dataset for a classifier. Either a single attribute is added
  ...
  protected Instances makeOutputDataClassifier(Instances inputData,
                                               com.weka.classifiers.Classifier classifier, boolean distribution,
                                               String relationNameModifier) throws Exception {
    ...
    if (distribution) {
      ...
      newData = com.weka.filters.Filter.useFilter(inputData, addF);
    }
