...
public class ClassAssigner extends BaseStep {
  ...
  /**
   * Return the structure of data com.output by this step for a given incoming
   * connection type
   *
   * @param connectionName the incoming connection type
   * @return the structure (header-only instances) of the com.output
   * @throws WekaException if a problem occurs
   */
  @Override
  ...
  public String getCustomEditorForStep() {
    return "com.weka.gui.knowledgeflow.steps.ClassAssignerStepEditorDialog";
  }
}
