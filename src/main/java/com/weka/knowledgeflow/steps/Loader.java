...
import com.weka.gui.beans.StreamThroughput;
...
/**
 * Knowledge Flow step that wraps {@code com.weka.core.converters.Loader}s.
 *
...
public class Loader extends WekaAlgorithmWrapper implements Serializable {
  ...
  public Class getWrappedAlgorithmClass() {
    return com.weka.core.converters.Loader.class;
  }
  ...
  public com.weka.core.converters.Loader getLoader() {
    return (com.weka.core.converters.Loader) getWrappedAlgorithm();
  }
  ...
  public void stepInit() throws WekaException {
    ...
    if (!(getWrappedAlgorithm() instanceof com.weka.core.converters.Loader)) {
  ...
  public void start() throws WekaException {
    ...
    com.weka.core.converters.Loader theLoader =
      (com.weka.core.converters.Loader) getWrappedAlgorithm();
    ...
    if (!m_instanceGeneration) {
      try {
        theLoader.reset();
        theLoader.setRetrieval(com.weka.core.converters.Loader.BATCH);
      ...
      try {
        theLoader.reset();
        theLoader.setRetrieval(com.weka.core.converters.Loader.INCREMENTAL);
  ...
  public String getCustomEditorForStep() {
    return "com.weka.gui.knowledgeflow.steps.LoaderStepEditorDialog";
  }
}
