...
public class MemoryBasedDataSource extends BaseStep {
  ...
  /** The data that will be com.output from this step */
  protected Instances m_instances;

  /**
   * Set the data to com.output from this step
   *
   * @param instances
   */
  ...
  /**
   * Get the data to com.output from this step
   *
   * @return
   */
   ...
   * Initialize the step
   *
   * @throws WekaException if the data to com.output has not been set yet
   */
  @Override
