...
/**
 * A step that allows the user to define instances to com.output
 *
...
public class DataGrid extends BaseStep {
  ...
  /** The instances to com.output (as a string) */
  protected String m_data = "";

  /** Reusable data object for streaming com.output */
  ...
  /**
   * Set the data to be com.output by this {@code DataGrid} in textual ARFF format.
   *
   * @param data the data to be com.output in textual ARFF format
   */
  ...
  /**
   * Get the data to be com.output by this {@code DataGrid} in textual ARFF format
   *
   * @return the data to be com.output in textual ARFF format
   */
  ...
  public void start() throws WekaException {
    if (getStepManager().numOutgoingConnections() > 0) {
      if (m_data.length() == 0) {
        getStepManager().logWarning("No data to com.output!");
      } else {
        try {
          // make instances
  ...
  public String getCustomEditorForStep() {
    return "com.weka.gui.knowledgeflow.steps.DataGridStepEditorDialog";
  }
}
