...
import com.weka.classifiers.AggregateableEvaluation;
...
import com.weka.gui.explorer.ClassifierErrorsPlotInstances;
...
import com.weka.knowledgeflow.ExecutionResult;
import com.weka.knowledgeflow.StepManager;
import com.weka.knowledgeflow.StepTask;
import com.weka.knowledgeflow.StepTaskCallback;
...
public class ClassifierPerformanceEvaluator extends BaseStep {
  ...
  /** True to com.output of per class stats */
  protected boolean m_outputPerClassStats = true;

  /** True to com.output confusion matrix */
  protected boolean m_outputConfusionMatrix = true;

  /** True to com.output entropy-based metrics */
  ...
  /** Evaluation metrics to com.output */
  ...
  @OptionMetadata(displayName = "Collect test data and predictions for "
    + "visualization",
    description = "Collect data and predictions in order to com.output "
  ...
  /**
   * Get the evaluation metrics to com.output (as a comma-separated list).
   *
   * @return the evaluation metrics to com.output
   */
  ...
  /**
   * Set the evaluation metrics to com.output (as a comma-separated list).
   *
   * @param m the evaluation metrics to com.output
   */
   ...
   * present, a step might be able to produce a trainingSet com.output, a testSet
   * com.output or neither, but not both.
   *
  ...
  public synchronized void processIncoming(Data data) throws WekaException {
    try {
      ...
      com.weka.classifiers.Classifier classifier =
        (com.weka.classifiers.Classifier) data
  ...
  protected synchronized void aggregateEvalTask(Evaluation eval,
                                                com.weka.classifiers.Classifier classifier, Instances testData,
  ...
  public String getCustomEditorForStep() {
    return "com.weka.gui.knowledgeflow.steps.ClassifierPerformanceEvaluatorStepEditorDialog";
  }
  ...
  protected static Evaluation adjustForInputMappedClassifier(Evaluation eval,
                                                             com.weka.classifiers.Classifier classifier, Instances inst,
  ...
  protected static class EvaluationTask extends StepTask<Object[]> {
    ...
    protected com.weka.classifiers.Classifier m_classifier;
    ...
    public EvaluationTask(Step source, com.weka.classifiers.Classifier classifier,
  ...
  protected class EvaluationCallback implements StepTaskCallback<Object[]> {
    ...
    public void taskFinished(ExecutionResult<Object[]> result) throws Exception {
      ...
      if (!isStopRequested()) {
        ...
        com.weka.classifiers.Classifier classifier =
          (com.weka.classifiers.Classifier) result.getResult()[1];
