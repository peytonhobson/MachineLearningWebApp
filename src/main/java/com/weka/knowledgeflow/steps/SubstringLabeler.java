...
import com.weka.gui.beans.SubstringLabelerRules;
...
@KFStep(name = "SubstringLabeler", category = "Tools",
  toolTipText = "Label instances according to substring matches in String "
    ...
    + "a missing value for the label attribute or be 'consumed' (i.e. they are not com.output).",
...
public class SubstringLabeler extends BaseStep {
   ...
   * instances or com.output them with missing value for the match attribute.
   */
  ...
  /** Reusable data object for com.output */
   ...
   * "consumed" rather than com.output with a missing value set for the new
   * attribute.
   *
  ...
  @OptionMetadata(displayName = "Consume non matching instances",
    description = "Instances that do not match any rules will be consumed, "
      + "rather than being com.output with a missing value for the new attribute",
    displayOrder = 2)
  ...
  public Instances outputStructureForConnectionType(String connectionName)
    ...
    // we com.output the same structure as we receive + one additional attribute
  ...
  public String getCustomEditorForStep() {
    return "com.weka.gui.knowledgeflow.steps.SubstringLabelerStepEditorDialog";
  }
}
