...
import com.weka.core.SparseInstance;
...
public class FPGrowth extends AbstractAssociator implements
  ...
  /** If set, then only com.output rules containing these itmes */
  ...
  protected ArrayList<BinaryItem> getSingletons(Object source) throws Exception {
    ...
    } else if (source instanceof com.weka.core.converters.ArffLoader) {
      data = ((com.weka.core.converters.ArffLoader) source).getStructure();
    }
    ...
    if (source instanceof Instances) {
      ...
      com.weka.core.converters.ArffLoader loader = (com.weka.core.converters.ArffLoader) source;
  ...
  protected FPTreeRoot buildFPTree(ArrayList<BinaryItem> singletons,
    ...
    } else if (dataSource instanceof com.weka.core.converters.ArffLoader) {
      data = ((com.weka.core.converters.ArffLoader) dataSource).getStructure();
    }
    ...
    if (dataSource instanceof Instances) {
      ...
      com.weka.core.converters.ArffLoader loader = (com.weka.core.converters.ArffLoader) dataSource;
      Instance current = null;
      int count = 0;
      while ((current = loader.getNextInstance(data)) != null) {
  ...
  public String numRulesToFindTipText() {
    return "The number of rules to com.output";
  }
  ...
  private void buildAssociations(Object source) throws Exception {
    ...
    if (source instanceof com.weka.core.converters.ArffLoader) {
      data = ((com.weka.core.converters.ArffLoader) source).getStructure();
    ...
    do {
      if (arffLoader) {
        ((com.weka.core.converters.ArffLoader) source).reset();
      }
  ...
  public static void main(String[] args) {
    try {
      ...
      if (!Utils.getFlag("disk", args)) {
        ...
        com.weka.core.converters.ArffLoader loader = null;
        if (filename.length() != 0) {
          loader = new com.weka.core.converters.ArffLoader();
