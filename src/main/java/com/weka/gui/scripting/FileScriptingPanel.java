...
import com.weka.gui.ComponentHelper;
import com.weka.gui.DocumentPrinting;
import com.weka.gui.ExtensionFileFilter;
import com.weka.gui.PropertyDialog;
import com.weka.gui.WekaFileChooser;
import com.weka.gui.scripting.event.ScriptExecutionEvent;
import com.weka.gui.scripting.event.ScriptExecutionEvent.Type;
import com.weka.gui.scripting.event.ScriptExecutionListener;
...
public abstract class FileScriptingPanel
  ...
  public abstract class BasicAction
     ...
     * @param icon	the icon name (no path required if in com.weka/gui/images), can be null
  ...
  protected class StartAction
     ...
     */
    public StartAction() {
      super((m_Script.canExecuteScripts() ? "Start" : "Start (missing classes?)"), "com.run.gif", "ctrl R", 'S');
      setEnabled(false);
    }
  ...
  /** the text pane for the com.output. */
   ...
   * @param icon	the icon to use (if located in com.weka/gui/images, not path required), can be null
