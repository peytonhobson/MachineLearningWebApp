...
/** 
 * This panel records the number of com.weka tasks running and displays a
...
public class WekaTaskMonitor
  ...
  /** The number of running com.weka threads */
  ...
  public WekaTaskMonitor() {
    ...
    if (imageURL != null) {
      ...
      /*    Image pic = Toolkit.getDefaultToolkit().
            getImage(ClassLoader.getSystemResource("com.weka/gui/weka_stationary.gif"));
            Image pic2 = Toolkit.getDefaultToolkit().
            getImage(ClassLoader.getSystemResource("com.weka/gui/weka_animated.gif")); */
