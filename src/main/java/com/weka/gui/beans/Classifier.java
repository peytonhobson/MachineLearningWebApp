...
import com.weka.core.EnvironmentHandler;
...
import com.weka.core.xml.XStream;
import com.weka.experiment.Task;
import com.weka.experiment.TaskStatusInfo;
...
/**
 * Bean that wraps around com.weka.classifiers
 * 
...
public class Classifier extends JPanel implements BeanCommon, Visible,
  ...
  private com.weka.classifiers.Classifier m_Classifier = new ZeroR();
  /** Template used for creating copies when building in parallel */
  private com.weka.classifiers.Classifier m_ClassifierTemplate = m_Classifier;
  ...
  /**
   * Set whether to block on receiving the last fold of the last com.run rather than
   * rejecting any further data until all processing is complete.
   * 
   * @param block true if we should block on the last fold of the last com.run.
   */
  ...
  /**
   * Gets whether we are blocking on the last fold of the last com.run rather than
   * rejecting any further data until all processing has been completed.
   * 
   * @return true if we are blocking on the last fold of the last com.run
   */
   ...
   * 
   * @param c a <code>com.weka.classifiers.Classifier</code> value
   */
  public void setClassifierTemplate(com.weka.classifiers.Classifier c) {
    ...
    if (!(m_ClassifierTemplate instanceof com.weka.classifiers.UpdateableClassifier)
    ...
    try {
      if (m_ClassifierTemplate instanceof com.weka.classifiers.misc.InputMappedClassifier) {
        m_Classifier =
          com.weka.classifiers.AbstractClassifier.makeCopy(m_ClassifierTemplate);
      }
    } catch (Exception e) {
   ...
   * @return the classifier template currently in use.
   */
  public com.weka.classifiers.Classifier getClassifierTemplate() {
    return m_ClassifierTemplate;
  }

  private void setTrainedClassifier(com.weka.classifiers.Classifier tc)
    throws Exception {

    // set the template
    com.weka.classifiers.Classifier newTemplate = null;
    String[] options = ((OptionHandler) tc).getOptions();
    newTemplate =
      com.weka.classifiers.AbstractClassifier.forName(tc.getClass().getName(),
        options);
   ...
   * 
   * @return a <code>com.weka.classifiers.Classifier</code> value
   */
  public com.weka.classifiers.Classifier getClassifier() {
    return m_Classifier;
  }
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof com.weka.classifiers.Classifier)) {
      throw new IllegalArgumentException(algorithm.getClass() + " : incorrect "
        + "type of algorithm (Classifier)");
    }
    setClassifierTemplate((com.weka.classifiers.Classifier) algorithm);
  }
  ...
  private void handleIncrementalEvent() {
    ...
    if (m_incrementalEvent.getStatus() == InstanceEvent.FORMAT_AVAILABLE) {
      ...
      try {
        ...
        if (m_trainingSet == null || !m_trainingSet.equalHeaders(dataset)
          ...
          if (!(m_ClassifierTemplate instanceof com.weka.classifiers.UpdateableClassifier)
            && !(m_ClassifierTemplate instanceof com.weka.classifiers.misc.InputMappedClassifier)) {
          ...
          if (m_ClassifierTemplate instanceof com.weka.classifiers.misc.InputMappedClassifier) {
            m_trainingSet =
              ((com.weka.classifiers.misc.InputMappedClassifier) m_Classifier)
                .getModelHeader(m_trainingSet);

            /*
             * // check to see if the classifier that gets loaded is updateable
             * com.weka.classifiers.Classifier tempC =
             * ((com.weka.classifiers.misc.InputMappedClassifier
             * )m_Classifier).getClassifier(); if (!(tempC instanceof
             * com.weka.classifiers.UpdateableClassifier)) {
             * 
             * }
             */
          }
    ...
    try {
      ...
      if (m_ClassifierTemplate instanceof com.weka.classifiers.UpdateableClassifier
        ...
        ((com.weka.classifiers.UpdateableClassifier) m_Classifier)
        ...
        if (m_textListeners.size() > 0) {
          ...
          modelString =
            "=== Classifier model ===\n\n" + "Scheme:   " + titleString + "\n"
              ...
              + modelString;
          titleString = "com.Model: " + titleString;
      ...
      try {
        if (m_train != null) {
          ...
          if (m_runNum == 1 && m_setNum == 1) {
            ...
            // of the last com.run has completed
          ...
          String msg =
            statusMessagePrefix() + "Building model for com.run " + m_runNum
              + " fold " + m_setNum;
          if (m_log != null) {
            m_log.statusMessage(msg);
          } else {
          ...
          com.weka.classifiers.Classifier classifierCopy =
            com.weka.classifiers.AbstractClassifier.makeCopy(m_ClassifierTemplate);
          ...
          // store in the com.output queue (if we have incoming test set events)
          ce =
            new BatchClassifierEvent(Classifier.this, classifierCopy,
          ...
          if (classifierCopy instanceof com.weka.core.Drawable
            && m_graphListeners.size() > 0) {
            String grphString = ((com.weka.core.Drawable) classifierCopy).graph();
            int grphType = ((com.weka.core.Drawable) classifierCopy).graphType();
  ...
  public void acceptTrainingSet(final TrainingSetEvent e) {
    ...
    // Do some initialization if this is the first set of the first com.run
    if (e.getRunNumber() == 1 && e.getSetNumber() == 1) {
      ...
      // setup com.output queues
      msg = "[Classifier] " + statusMessagePrefix() + " setup com.output queues.";
      if (m_log != null) {
        m_log.logMessage(msg);
      } else {
        System.err.println(msg);
    ...
    String msg =
      "[Classifier] " + statusMessagePrefix() + " scheduling com.run "
  ...
  public synchronized void acceptTestSet(TestSetEvent e) {
    ...
    com.weka.classifiers.Classifier classifierToUse = m_Classifier;

    // If we just have a test set connection or
    // there is just one com.run involving one set (and we are not
    ...
    if (classifierToUse != null && m_state == IDLE
      ...
      if (classifierToUse instanceof com.weka.classifiers.misc.InputMappedClassifier) {
        ...
        try {
          m_trainingSet =
            ((com.weka.classifiers.misc.InputMappedClassifier) classifierToUse)
      ...
      if (testSet != null) {
        if (!m_trainingSet.equalHeaders(testSet)
          && !(classifierToUse instanceof com.weka.classifiers.misc.InputMappedClassifier)) {
          boolean wrapClassifier = false;
          if (!Utils
            .getDontShowDialog("com.weka.gui.beans.Classifier.AutoWrapInInputMappedClassifier")) {
      ...
      /*
       * System.err.println("[Classifier] accepting test set: com.run " +
      ...
      if (m_outputQueues[e.getRunNumber() - 1][e.getSetNumber() - 1] == null) {
        ...
        if (!e.isStructureOnly()) {
          ...
          if (e.getRunNumber() == e.getMaxRunNumber()
            ...
            // block on the last fold of the last com.run (unless there is only one
            // fold and one com.run)
            /*
             * System.err.println(
             * "[Classifier] blocking on last fold of last com.run..." );
             * block(true);
             */
  ...
  private synchronized void classifierTrainingComplete(BatchClassifierEvent ce) {
    // check the com.output queues if we have an incoming test set connection
    if (m_listenees.containsKey("testSet")) {
      String msg =
        "[Classifier] " + statusMessagePrefix() + " storing model for com.run "
    ...
    for (int i = 0; i < maxSets; i++) {
      if (m_outputQueues[runNum - 1][i] != null) {
        if (m_outputQueues[runNum - 1][i].getClassifier() != null
          ...
          String msg =
            "[Classifier] " + statusMessagePrefix() + " dispatching com.run/set "
   ...
   * " dispatching com.run " + runNum + " to listeners."; if (m_log != null) {
   * m_log.logMessage(msg); } else { System.err.println(msg); } // dispatch this
   * com.run to listeners for (int i = 0; i < maxSets; i++) {
      ...
      for (int i = 0; i < l.size(); i++) {
        if (l.size() > 1) {
          try {
            ...
            com.weka.classifiers.Classifier newC =
              com.weka.classifiers.AbstractClassifier.makeCopy(ce.getClassifier());
  ...
  public boolean connectionAllowed(String eventName) {
     ...
     * com.weka.classifiers.UpdateableClassifier)) { return false; } }
     */
  ...
  public synchronized void connectionNotification(String eventName,
    ...
    if (eventName.equals("testSet") && m_listenees.containsKey("testSet")
      && m_log != null) {
      if (!Utils
        .getDontShowDialog("com.weka.gui.beans.ClassifierMultipleTestSetConnections")
        ...
        String msg =
          "You have more than one incoming test set connection to \n"
            + "'"
            + getCustomName()
            + "'. In order for this setup to com.run properly\n"
        ...
        if (dontShow.isSelected()) {
          try {
            Utils
              .setDontShowDialog("com.weka.gui.beans.ClassifierMultipleTestSetConnections");
          } catch (Exception ex) {
            // quietly ignore
          }
        }
  ...
  protected void loadFromFile(File loadFrom) throws Exception {
    com.weka.classifiers.Classifier temp = null;
    ...
    if ((KOML.isPresent())
      ...
      temp = (com.weka.classifiers.Classifier) v.elementAt(0);
      if (v.size() == 2) {
      ...
      temp = (com.weka.classifiers.Classifier) is.readObject();
  ...
  public void saveModel() {
    try {
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION) {
        ...
        if (m_log != null) {
          m_log.statusMessage(statusMessagePrefix() + "com.Model saved.");
          m_log.logMessage("[Classifier] " + statusMessagePrefix()
      ...
      JOptionPane
        .showMessageDialog(Classifier.this, "Problem saving classifier.\n",
          "Save com.Model", JOptionPane.ERROR_MESSAGE);
      if (m_log != null) {
  ...
  public boolean eventGeneratable(String eventName) {
    ...
    if (eventName.compareTo("graph") == 0) {
      ...
      if (!(m_ClassifierTemplate instanceof com.weka.core.Drawable)) {
        return false;
      }
    ...
    if (eventName.compareTo("incrementalClassifier") == 0) {
      /*
       * if (!(m_Classifier instanceof com.weka.classifiers.UpdateableClassifier)) {
       * return false; }
       */
      if (!m_listenees.containsKey("instance")) {
        return false;
