 ...
 * @version $Revision$
 * @deprecated Use com.weka.core.PluginManager instead
 */
@Deprecated
public class PluginManager {
  ...
  public static synchronized void addToDisabledList(List<String> classnames) {
    com.weka.core.PluginManager.addToDisabledList(classnames);
  }
  ...
  public static synchronized void addToDisabledList(String classname) {
    com.weka.core.PluginManager.addToDisabledList(classname);
  }
  ...
  public static synchronized void
    ...
    com.weka.core.PluginManager.removeFromDisabledList(classnames);
  }
  ...
  public static synchronized void removeFromDisabledList(String classname) {
    com.weka.core.PluginManager.removeFromDisabledList(classname);
  }
  ...
  public static boolean isInDisabledList(String classname) {
    return com.weka.core.PluginManager.isInDisabledList(classname);
  }
  ...
  public static synchronized void addFromProperties(File propsFile)
    throws Exception {
    com.weka.core.PluginManager.addFromProperties(propsFile);
  }
  ...
  public static synchronized void addFromProperties(InputStream propsStream)
    throws Exception {
    com.weka.core.PluginManager.addFromProperties(propsStream);
  }
  ...
  public static synchronized void addFromProperties(Properties props)
    throws Exception {
    com.weka.core.PluginManager.addFromProperties(props);
  }
  ...
  public static synchronized void addFromProperties(Properties props,
    boolean maintainInsertionOrder) throws Exception {
    com.weka.core.PluginManager.addFromProperties(props, maintainInsertionOrder);
  }
  ...
  public static synchronized void addPluginResource(String resourceGroupID,
    ...
    com.weka.core.PluginManager.addPlugin(resourceGroupID, resourceDescription,
      resourcePath);
  }
  ...
  public static InputStream getPluginResourceAsStream(String resourceGroupID,
    ...
    return com.weka.core.PluginManager.getPluginResourceAsStream(resourceGroupID,
      resourceDescription);
  }
  ...
  public static int numResourcesForWithGroupID(String resourceGroupID) {
    return com.weka.core.PluginManager.numResourcesForWithGroupID(resourceGroupID);
  }
  ...
  public static Map<String, String> getResourcesWithGroupID(
    ...
    return com.weka.core.PluginManager.getResourcesWithGroupID(resourceGroupID);
  }
  ...
  public static Set<String> getPluginNamesOfType(String interfaceName) {
    return com.weka.core.PluginManager.getPluginNamesOfType(interfaceName);
  }
  ...
  public static void addPlugin(String interfaceName, String name,
    String concreteType) {
    com.weka.core.PluginManager.addPlugin(interfaceName, name, concreteType);
  }
  ...
  public static void removePlugins(String interfaceName, List<String> names) {
    for (String name : names) {
      com.weka.core.PluginManager.removePlugins(interfaceName, names);
    }
  }
  ...
  public static void removePlugin(String interfaceName, String name) {
    com.weka.core.PluginManager.removePlugin(interfaceName, name);
  }
  ...
  public static Object getPluginInstance(String interfaceType, String name)
    throws Exception {
    return com.weka.core.PluginManager.getPluginInstance(interfaceType, name);
  }
}
