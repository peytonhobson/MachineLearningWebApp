...
public class SerializedModelSaver extends JPanel implements BeanCommon,
   ...
   */
  protected transient com.weka.gui.Logger m_logger = null;
  ...
  public void acceptClassifier(final BatchClassifierEvent ce) {
    ...
    if (ce.getClassifier() instanceof com.weka.classifiers.misc.InputMappedClassifier) {
      try {
        trainHeader = ((com.weka.classifiers.misc.InputMappedClassifier) ce
