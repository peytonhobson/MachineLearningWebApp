...
public class TrainingSetEvent
  ...
  /**
   * What com.run number is this training set from.
   */
   ...
   * @param source the source of the event
   * @param trainSet the training instances
   * @param runNum the com.run number that the training set belongs to
   * @param maxRunNum the maximum com.run number
   * @param setNum the number of the training set
   * @param maxSetNum the maximum number of sets
   */
  ...
  /**
   * Get the com.run number that this training set belongs to.
   * 
   * @return the com.run number for this training set.
   */
