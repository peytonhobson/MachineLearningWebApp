...
public class AssociatorCustomizer
  ...
  private com.weka.gui.beans.Associator m_dsAssociator;
  ...
  private com.weka.associations.Associator m_backup;
  ...
  public void setObject(Object object) {
    m_dsAssociator = (com.weka.gui.beans.Associator)object;
    //    System.err.println(Utils.joinOptions(((OptionHandler)m_dsClassifier.getClassifier()).getOptions()));
    try {
      m_backup = 
        (com.weka.associations.Associator)GenericObjectEditor.makeCopy(m_dsAssociator.getAssociator());
    } catch (Exception ex) {
      // ignore
    }
