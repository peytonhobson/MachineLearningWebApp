 ...
 * determining the com.output structure with respect to a set of rules and for
 * constructing com.output instances that have been labeled according to the rules.
 * 
...
public class SubstringLabelerRules implements EnvironmentHandler, Serializable {
  ...
  /**
   * True if non matching instances should be "consumed" - i.e no com.output
   * instance created
   */
   ...
   *          matching, and thus labelled, instances will be com.output)
   */
   ...
   * provided, then the com.output attribute is a binary indicator one (i.e. a rule
  ...
  /**
   * Get the com.output structure
   * 
   * @return the structure of the com.output instances
   */
  ...
  /**
   * Make the com.output instances structure
   * 
  ...
  protected void makeOutputStructure() throws Exception {
    ...
    if (m_matchRules.size() > 0) {
      ...
      /*
       * // make the com.output structure m_addFilter = new Add();
  ...
  /**
   * Process and input instance and return an com.output instance
   * 
   * @param inputI the incoming instance
   * @param batch whether this is being processed as part of a batch of
   *          instances
   * 
   * @throws Exception if the com.output structure has not yet been determined
   * @return the com.output instance
   */
