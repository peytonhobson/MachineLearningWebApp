...
public class Filter extends JPanel implements BeanCommon, Visible, WekaWrapper,
   ...
   * The filter to use.
   */
  private com.weka.filters.Filter m_Filter = new AllFilter();
   ...
   * 
   * @param c a <code>com.weka.filters.Filter</code> value
   */
  public void setFilter(com.weka.filters.Filter c) {
   ...
   * Set the filter to be wrapped by this bean
   * 
   * @param algorithm a com.weka.filters.Filter
   * @exception IllegalArgumentException if an error occurs
   */
  @Override
  public void setWrappedAlgorithm(Object algorithm) {

    if (!(algorithm instanceof com.weka.filters.Filter)) {
      throw new IllegalArgumentException(algorithm.getClass() + " : incorrect "
        + "type of algorithm (Filter)");
    }
    setFilter((com.weka.filters.Filter) algorithm);
  }
      ...
      try {
        ...
        try {
          if (m_Filter.isOutputFormatDefined()) {
            // System.err.println("Filter - passing on com.output format...");
    ...
    if (e.getStatus() == InstanceEvent.BATCH_FINISHED
        ...
        if (e.getInstance() != null) {
          if (m_Filter.input(e.getInstance())) {
            ...
            if (filteredInstance != null) {
              ...
              // if there are instances pending for com.output don't want to send
      ...
      try {
        if (!m_Filter.input(e.getInstance())) {
          ...
          /*
           * if (m_log != null) {
           * m_log.logMessage("ERROR : filter not ready to com.output instance"); }
           */

          // quietly return. Filter might be able to com.output some instances
          // once the batch is finished.
          return;
        }

        // collect com.output instance.
        Instance filteredInstance = m_Filter.output();
        if (filteredInstance == null) {
          return;
        }
            ...
            public void run() {
              try {
                if (m_trainingSet != null) {
                  ...
                  Instances filteredData = com.weka.filters.Filter.useFilter(
                    m_trainingSet, m_Filter);
                  // m_visual.setText(oldText);
                  m_visual.setStatic();
                  EventObject ne;
                  if (e instanceof TrainingSetEvent) {
                    ne = new TrainingSetEvent(com.weka.gui.beans.Filter.this,
                      filteredData);
                    ...
                    ne = new DataSetEvent(com.weka.gui.beans.Filter.this,
                      filteredData);
                  }
          ...
          public void run() {
            try {
              if (m_testingSet != null) {
                ...
                Instances filteredTest = com.weka.filters.Filter.useFilter(
                  m_testingSet, m_Filter);
                // m_visual.setText(oldText);
                m_visual.setStatic();
                TestSetEvent ne = new TestSetEvent(com.weka.gui.beans.Filter.this,
                  filteredTest);
