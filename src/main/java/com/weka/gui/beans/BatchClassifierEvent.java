...
public class BatchClassifierEvent extends EventObject {
  ...
  /**
   * The com.run number that this classifier was generated for
   */
   ...
   * @param trsI the training instances used to train the classifier
   * @param tstI the test instances
   * @param runNum the com.run number
  ...
  /**
   * Get the com.run number.
   * 
   * @return the com.run number
   */
  ...
  /**
   * Get the maximum com.run number
   * 
   * @return the maximum com.run number
   */
