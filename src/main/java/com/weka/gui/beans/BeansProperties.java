...
import com.weka.core.metastore.MetaStore;
import com.weka.core.metastore.XMLFileBasedMetaStore;
...
public class BeansProperties implements Serializable {
  ...
  public static synchronized void loadProperties() {
    if (BEAN_PROPERTIES == null) {
      com.weka.core.WekaPackageManager.loadPackages(false);
      ...
      if (VISIBLE_PERSPECTIVES == null) {
        ...
        pp.setProperty("com.weka.gui.beans.KnowledgeFlow.Perspectives",
          "com.weka.gui.beans.ScatterPlotMatrix,com.weka.gui.beans.AttributeSummarizer,"
            + "com.weka.gui.beans.SQLViewerPerspective");
        ...
        try {
          ...
          if (keys.hasMoreElements()) {
            String listedPerspectives =
              visible
                .getProperty("com.weka.gui.beans.KnowledgeFlow.SelectedPerspectives");
            if (listedPerspectives != null && listedPerspectives.length() > 0) {
              ...
              while (st.hasMoreTokens()) {
                ...
                com.weka.core.logging.Logger.log(
                  com.weka.core.logging.Logger.Level.INFO, "Adding perspective "
    ...
    if (TEMPLATE_PATHS == null) {
      ...
      try {
        ...
        String paths =
          templateProps.getProperty("com.weka.gui.beans.KnowledgeFlow.templates");
        String descriptions =
          templateProps
            .getProperty("com.weka.gui.beans.KnowledgeFlow.templates.desc");
    ...
    if (!s_pluginManagerIntialized && BEAN_PLUGINS_PROPERTIES != null
      ...
      for (int i = 0; i < BEAN_PLUGINS_PROPERTIES.size(); i++) {
        ...
        String offscreenRenderers =
          tempP.getProperty("com.weka.gui.beans.OffscreenChartRenderer");
            ...
            try {
              ...
              if (p instanceof OffscreenChartRenderer) {
                ...
                PluginManager.addPlugin(
                  "com.weka.gui.beans.OffscreenChartRenderer", name, renderer);
                com.weka.core.logging.Logger.log(
        ...
        String templatePaths =
          tempP.getProperty("com.weka.gui.beans.KnowledgeFlow.templates");
        String templateDesc =
          tempP.getProperty("com.weka.gui.beans.KnowledgeFlow.templates.desc");
