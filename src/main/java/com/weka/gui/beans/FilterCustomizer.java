...
public class FilterCustomizer extends JPanel implements BeanCustomizer,
  ...
  public void setObject(Object object) {
    m_filter = (com.weka.gui.beans.Filter) object;
    try {
      m_backup = (com.weka.filters.Filter) GenericObjectEditor.makeCopy(m_filter
          .getFilter());
    } catch (Exception ex) {
      // ignore
    }
