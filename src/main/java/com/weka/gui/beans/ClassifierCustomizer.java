...
public class ClassifierCustomizer extends JPanel implements BeanCustomizer,
  ...
  private com.weka.gui.beans.Classifier m_dsClassifier;
  /*
  ...
  private final JCheckBox m_blockOnLastFold = new JCheckBox(
      "Block on last fold of last com.run");
  ...
  protected com.weka.classifiers.Classifier m_backup;
  ...
  private void checkOnClassifierType() {
    ...
    if (editedC instanceof com.weka.classifiers.UpdateableClassifier
  ...
  public void setObject(Object object) {
    m_dsClassifier = (com.weka.gui.beans.Classifier) object;
    // System.err.println(Utils.joinOptions(((OptionHandler)m_dsClassifier.getClassifier()).getOptions()));
    try {
      m_backup = (com.weka.classifiers.Classifier) GenericObjectEditor
   ...
   * (non-Javadoc)
   * 
   * @see com.weka.gui.beans.CustomizerClosingListener#customizerClosing()
   */
  @Override
