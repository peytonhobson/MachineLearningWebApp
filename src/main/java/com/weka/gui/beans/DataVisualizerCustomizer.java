...
public class DataVisualizerCustomizer extends JPanel implements
  ...
  private void setup() {
    ...
    Set<String> pluginRenderers = 
      PluginManager.getPluginNamesOfType("com.weka.gui.beans.OffscreenChartRenderer");
  ...
  private void setupRendererOptsTipText(JLabel optsLab) {
    ...
    if (renderer.equalsIgnoreCase("com.weka chart renderer")) {
      ...
      try {
        Object rendererO = PluginManager.getPluginInstance("com.weka.gui.beans.OffscreenChartRenderer",
            renderer);
