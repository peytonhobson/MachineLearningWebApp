...
implements BeanCustomizer, CustomizerCloseRequester, EnvironmentHandler {
  ...
  private com.weka.gui.beans.Saver m_dsSaver;
...
/*    width = m_directoryText.getPreferredSize().width;
   ...
   *
   * @param object a com.weka.gui.beans.Saver
   */
  public void setObject(Object object) {
    m_dsSaver = (com.weka.gui.beans.Saver)object;
  ...
  /* (non-Javadoc)
   * @see com.weka.core.EnvironmentHandler#setEnvironment(com.weka.core.Environment)
   */
