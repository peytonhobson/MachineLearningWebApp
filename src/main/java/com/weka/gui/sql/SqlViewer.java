...
package com.weka.gui.sql;

import com.weka.core.Memory;
import com.weka.core.WekaPackageManager;
import com.weka.gui.LookAndFeel;
import com.weka.gui.sql.event.ConnectionEvent;
import com.weka.gui.sql.event.ConnectionListener;
import com.weka.gui.sql.event.HistoryChangedEvent;
import com.weka.gui.sql.event.HistoryChangedListener;
import com.weka.gui.sql.event.QueryExecuteEvent;
import com.weka.gui.sql.event.QueryExecuteListener;
import com.weka.gui.sql.event.ResultChangedEvent;
import com.weka.gui.sql.event.ResultChangedListener;
...
public class SqlViewer extends JPanel implements ConnectionListener,
  ...
  /** the connect string with which the query was com.run. */
