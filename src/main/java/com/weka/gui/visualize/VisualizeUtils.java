...
public class VisualizeUtils {
  ...
  static {
    ...
    try {
      ...
      String precision =
        VISUALIZE_PROPERTIES.getProperty("com.weka.gui.visualize.precision");
      if (precision == null) {
        /*
         * System.err.println("Warning: no configuration property found in"
         * +PROPERTY_FILE +" for com.weka.gui.visualize.precision. Using"
         * +" default instead.");
         */
      } else {
  ...
  public static class VisualizeDefaults extends Defaults {
    ...
    public static final String ID = "com.weka.gui.visualize.visualizepanel";
