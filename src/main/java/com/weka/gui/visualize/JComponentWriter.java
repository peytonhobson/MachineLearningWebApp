...
public abstract class JComponentWriter {
  ...
  /** com.output if we're in debug mode */
  static {
    if (DEBUG)
      System.err.println(JComponentWriter.class.getName() + ": DEBUG ON");
  }
  
  /** the component to print in the com.output format */
  private JComponent component;
  
  /** the file to write the com.output stream to */
  ...
  /**
   * sets the component to print to an com.output format
   * 
  ...
  /**
   * returns the component that is stored in the com.output format
   * 
  ...
  /**
   * sets the file to store the com.output in
   * 
   * @param f the file to store the com.output in
   */
  ...
  /**
   * returns the file being used for storing the com.output
   * 
   * @return the file to store the com.output in
   */
  public File getFile() {
    return outputFile;
  }
   ...
   * @param comp	the component to com.output
   * @param file	the file to store the com.output in
