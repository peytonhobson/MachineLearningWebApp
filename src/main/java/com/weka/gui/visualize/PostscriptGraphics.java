 ...
 * PostscriptGraphics before com.output. To use, create a PostscriptGraphics object,
...
public class PostscriptGraphics extends Graphics2D {
  ...
  /** The bounding box of the com.output */
