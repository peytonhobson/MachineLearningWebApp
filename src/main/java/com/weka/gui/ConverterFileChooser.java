...
import com.weka.core.converters.AbstractLoader;
import com.weka.core.converters.AbstractSaver;
import com.weka.core.converters.ConverterResources;
...
public class ConverterFileChooser extends WekaFileChooser {
   ...
   * 
   * @see com.weka.core.converters.ConverterResources#CORE_FILE_LOADERS
   * @see com.weka.core.converters.ConverterResources#CORE_FILE_SAVERS
   */
  ...
  protected void initGUI(int dialogType) {
    ...
    if (dialogType == LOADER_DIALOG) {
      ...
      m_Editor.setValue(new com.weka.core.converters.ArffLoader());
    } else {
      m_Editor.setClassType(AbstractFileSaver.class);
      m_Editor.setValue(new com.weka.core.converters.ArffSaver());
    }
