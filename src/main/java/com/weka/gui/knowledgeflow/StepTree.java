...
import com.weka.gui.knowledgeflow.VisibleLayout.LayoutOperation;
...
public class StepTree extends JTree {
  ...
  protected void populateTree(DefaultMutableTreeNode jtreeRoot)
    ...
    String stepClassNames =
      builtinSteps.getProperty("com.weka.knowledgeflow.steps.Step");
    ...
    Set<String> stepClasses =
      PluginManager.getPluginNamesOfType("com.weka.knowledgeflow.steps.Step");
    ...
    for (String stepClass : stepClasses) {
      try {
        ...
        if (toAdd.getClass().getAnnotation(StepTreeIgnore.class) != null
          || toAdd.getClass().getAnnotation(com.weka.gui.beans.KFIgnore.class) != null) {
          continue;
        }
  ...
  /**
   * Populates a target folder in the tree for a particular class of com.weka
  ...
  protected void populateForWekaWrapper(DefaultMutableTreeNode targetFolder,
    ...
    if (implList == null) {
      throw new WekaException(
        "Unable to get a list of com.weka implementations for " + "class '"
    ...
    for (String primaryPackage : primaryPackages) {
      ...
      if (hpp.isLeafReached()) {
        ...
        if (wrappedA.getClass().getAnnotation(StepTreeIgnore.class) == null
          && wrappedA.getClass().getAnnotation(com.weka.gui.beans.KFIgnore.class) == null) {
