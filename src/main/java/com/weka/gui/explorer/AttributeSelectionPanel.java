...
import com.weka.attributeSelection.ASEvaluation;
import com.weka.attributeSelection.ASSearch;
import com.weka.attributeSelection.AttributeEvaluator;
import com.weka.attributeSelection.AttributeSelection;
import com.weka.attributeSelection.AttributeTransformer;
import com.weka.attributeSelection.BestFirst;
import com.weka.attributeSelection.CfsSubsetEval;
import com.weka.attributeSelection.Ranker;
...
import com.weka.gui.visualize.MatrixPanel;
 ...
 * @version $Revision$
 */
@PerspectiveInfo(ID = "com.weka.gui.explorer.attributeselectionpanel",
...
public class AttributeSelectionPanel extends AbstractPerspective implements
  ...
  /** The com.output area for attribute selection results */
  ...
  public AttributeSelectionPanel() {
        ...
        public void propertyChange(PropertyChangeEvent e) {
          if (m_AttributeEvaluatorEditor.getValue() instanceof AttributeEvaluator) {
            ...
            if (m_AttributeSearchEditor.getValue() instanceof Ranker) {
              ...
              if (result == JOptionPane.YES_OPTION) {
                m_AttributeSearchEditor
                  .setValue(new com.weka.attributeSelection.GreedyStepwise());
              } else {
                // restore to what was there previously (if possible)
                if (backup != null) {
                  m_AttributeEvaluatorEditor.setValue(backup);
        ...
        public void propertyChange(PropertyChangeEvent e) {
          if (m_AttributeSearchEditor.getValue() instanceof Ranker) {
            if (!(m_AttributeEvaluatorEditor.getValue() instanceof AttributeEvaluator)) {
              ...
              if (result == JOptionPane.YES_OPTION) {
                m_AttributeEvaluatorEditor
                  .setValue(new com.weka.attributeSelection.InfoGainAttributeEval());
              } else {
                // restore to what was there previously (if possible)
                if (backup != null) {
            ...
            if (m_AttributeEvaluatorEditor.getValue() instanceof AttributeEvaluator) {
              ...
              if (result == JOptionPane.YES_OPTION) {
                m_AttributeEvaluatorEditor
                  .setValue(new com.weka.attributeSelection.CfsSubsetEval());
              } else {
                // restore to what was there previously (if possible)
                if (backup != null) {
                  m_AttributeSearchEditor.setValue(backup);
    ...
    p3.setBorder(BorderFactory.createTitledBorder("Attribute selection com.output"));
   ...
   * method. This is com.run in a separate thread, and will only start if there is
   * no attribute selection already running. The attribute selection com.output is
    ...
    if (m_RunThread == null) {
      ...
      m_RunThread = new Thread() {
        ...
        public void run() {
          ...
          if (sname.startsWith("com.weka.attributeSelection.")) {
            name += sname.substring("com.weka.attributeSelection.".length());
          } else {
            name += sname;
          }
          String ename = evaluator.getClass().getName();
          if (ename.startsWith("com.weka.attributeSelection.")) {
            name +=
              (" + " + ename.substring("com.weka.attributeSelection.".length()));
          } else {
            name += (" + " + ename);
          }
          ...
          // 2. filter command
          com.weka.filters.supervised.attribute.AttributeSelection filter =
            new com.weka.filters.supervised.attribute.AttributeSelection();
          ...
          com.weka.classifiers.meta.AttributeSelectedClassifier cls =
            new com.weka.classifiers.meta.AttributeSelectedClassifier();
          cls
          ...
          try {
            ...
            // Do the feature selection and com.output the results.
  ...
  protected static final class AttributeSelectionPanelDefaults extends Defaults {
    ...
    public static final String ID = "com.weka.gui.explorer.attributeselectionpanel";
