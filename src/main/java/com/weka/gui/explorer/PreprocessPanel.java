...
import com.weka.core.converters.AbstractFileSaver;
import com.weka.core.converters.ConverterUtils;
import com.weka.core.converters.Loader;
import com.weka.core.converters.SerializedInstancesLoader;
import com.weka.core.converters.URLSourcedLoader;
import com.weka.datagenerators.DataGenerator;
import com.weka.experiment.InstanceQuery;
import com.weka.filters.AllFilter;
import com.weka.filters.Filter;
import com.weka.filters.SupervisedFilter;
...
import com.weka.gui.AttributeSummaryPanel;
import com.weka.gui.AttributeVisualizationPanel;
...
import com.weka.gui.ViewerDialog;
import com.weka.gui.WekaFileChooser;
import com.weka.gui.WorkbenchApp;
...
import com.weka.gui.sql.SqlViewerDialog;
 ...
 * @version $Revision$
 */
@PerspectiveInfo(ID = "com.weka.gui.explorer.preprocesspanel",
...
public class PreprocessPanel extends AbstractPerspective implements
  ...
  public PreprocessPanel() {
    ...
    m_FilterEditor.setClassType(com.weka.filters.Filter.class);
    ...
    if (!m_UndoBut.isEnabled()) {
      m_UndoBut.setToolTipText("Undo is disabled - "
        + "see com.weka.gui.explorer.Explorer.props to enable");
    }
    m_EditBut
    ...
    visAllBut.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
        if (m_Instances != null) {
          try {
            final com.weka.gui.beans.AttributeSummarizer as =
              new com.weka.gui.beans.AttributeSummarizer();
  ...
  protected void showGeneratedInstances(String data) {
    ...
    saveButton.setToolTipText("Saves the com.output to a file");
  ...
  private void converterQuery(final File f) {
    ...
    try {
      convEd.setClassType(com.weka.core.converters.Loader.class);
      convEd.setValue(new com.weka.core.converters.CSVLoader());
      ActionListener al = new ActionListener() {
        public void actionPerformed(ActionEvent e) {
  ...
  public static class PreprocessDefaults extends Defaults {
    public static final String ID = "com.weka.gui.explorer.preprocesspanel";
