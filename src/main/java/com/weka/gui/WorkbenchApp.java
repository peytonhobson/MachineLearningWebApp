...
import com.weka.gui.explorer.PreprocessPanel;
...
public class WorkbenchApp extends AbstractGUIApplication {
  ...
  public WorkbenchApp() {
    super(true, new String[0], new String[] {
      com.weka.gui.knowledgeflow.AttributeSummaryPerspective.class
        .getCanonicalName(),
      com.weka.gui.knowledgeflow.ScatterPlotMatrixPerspective.class
        .getCanonicalName(),
      com.weka.gui.knowledgeflow.SQLViewerPerspective.class.getCanonicalName() });
