...
/** 
 * This panel controls configuration of lower and upper com.run numbers
 * in an experiment.
 *
...
public class RunNumberPanel
  ...
  /** Configures the lower com.run number */
  protected JTextField m_LowerText = new JTextField("1");

  /** Configures the upper com.run number */
  ...
  /**
   * Gets the current lower com.run number.
   *
   * @return the lower com.run number.
   */
  public int getLower() {
  ...
  /**
   * Gets the current upper com.run number.
   *
   * @return the upper com.run number.
   */
  public int getUpper() {
