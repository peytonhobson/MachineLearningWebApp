...
public class DistributeExperimentPanel
  ...
  /**
   * Split experiment up by com.run number.
   */
  protected JRadioButton m_splitByRun = new JRadioButton("By com.run");
  ...
  public DistributeExperimentPanel() {
    ...
    m_splitByRun.setToolTipText("Distribute experiment by com.run number");
