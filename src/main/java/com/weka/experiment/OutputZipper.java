...
/**
 * OutputZipper writes com.output to either gzipped files or to a
 * multi entry zip file. If the destination file is a directory
 * each com.output string will be written to an individually named
 * gzip file. If the destination file is a file, then each
 * com.output string is appended as a named entry to the zip file until
...
public class OutputZipper
   ...
   * 
   * @param outString the com.output string to save
