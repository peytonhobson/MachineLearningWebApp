...
/**
 <!-- globalinfo-start -->
 * Generates the matrix com.output in LaTeX-syntax.
 * <p/>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
...
public class ResultMatrixLatex
  ...
  public String globalInfo() {
    return "Generates the matrix com.output in LaTeX-syntax.";
  }
  ...
  public String toStringMatrix() {
    ...
    // com.output the column alignment characters
    ...
    // com.output data (w/o wins/ties/losses)
