 ...
 * <pre>
 * 
 * java -Djava.rmi.server.codebase=file:/path to com.weka classes/ \
 * com.weka.experiment.RemoteExperiment -L 1 -U 10 \
 * -T /home/ml/datasets/UCI/iris.arff \
 * -D "com.weka.experiment.DatabaseResultListener" \
 * -P "com.weka.experiment.RandomSplitResultProducer" \
 * -h rosebud.cs.waikato.ac.nz -h blackbird.cs.waikato.ac.nz -r -- \
 * -W com.weka.experiment.ClassifierSplitEvaluator -- \
 * -W com.weka.classifiers.bayes.NaiveBayes
 * 
 * </pre>
 * <p>
 * The "codebase" property tells rmi where to serve up com.weka classes from. This
 ...
 * supposes that a web server is running and you have put your com.weka classes
 * somewhere that is web accessable). If using a file url the trailing "/" is
 * *most* important unless the com.weka classes are in a jar file.
 * <p>
 * 
...
public class RemoteExperiment extends Experiment {
   ...
   *         to be created on the basis of data set (true) or com.run number
   *         (false).
   */
   ...
   *          set. Otherwise sub experiments are created on the basis of com.run
   *          number.
   */
  ...
  /**
   * Set the base experiment. A sub experiment will be created for each com.run in
   * the base experiment.
   * 
   * @param base the base experiment to use.
  ...
  public void initialize() throws Exception {
    ...
    if (getSplitByDataSet()) {
      ...
      for (int i = getRunLower(); i <= getRunUpper(); i++) {
        ...
        // one com.run for each sub experiment
    ...
    subExpThread = new Thread() {
      ...
      public void run() {
        ...
        if (getSplitByDataSet()) {
          ...
          subTaskType = "com.run: " + m_subExperiments[wexp].getRunLower();
        }
        try {
