 ...
 * just use '.*-com.weka' as the regular expression to find.<br/>
...
public class ExplicitTestsetResultProducer implements ResultProducer,
  ...
  public String globalInfo() {
    return "Loads the external test set and calls the appropriate "
      ...
      + "add to the end of the relation name, just use '.*-com.weka' as the "
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option("Save raw split evaluator com.output.", "D", 0,
      "-D"));
  ...
  public void doRunKeys(int run) throws Exception {
    ...
    // Add in some fields to the key like com.run number, dataset name
  ...
  protected String createFilename(Instances inst) {
    ...
    // substitute the com.run number (and any other variables)
    // if specified
    try {
   ...
   * 
   * @param value true if com.output is to be saved
   */
