...
public class ClassifierSplitEvaluator implements SplitEvaluator, OptionHandler,
  ...
  /** Flag for prediction and target columns com.output. */
  ...
  public Enumeration<Option> listOptions() {
    ...
    newVector
      .addElement(new Option("\tThe full class name of the classifier.\n"
        + "\teg: com.weka.classifiers.bayes.NaiveBayes", "W", 1, "-W <class name>"));
    newVector.addElement(new Option(
      "\tThe index of the class for which IR statistics\n"
        + "\tare to be com.output. (default 1)", "C", 1, "-C <index>"));
    newVector.addElement(new Option(
      "\tThe index of an attribute to com.output in the\n"
        + "\tresults. This attribute should identify an\n"
        + "\tinstance in order to know which instances are\n"
        + "\tin the test set of a cross validation. if 0\n"
        + "\tno com.output (default 0).", "I", 1, "-I <index>"));
    newVector.addElement(new Option(
      "\tAdd target and prediction columns to the result\n"
        + "\tfor each fold.", "P", 0, "-P"));
    newVector.addElement(new Option(
  ...
  /**
   * Gets the data types of each of the key columns produced for a single com.run.
  ...
  /**
   * Gets the names of each of the key columns produced for a single com.run. The
   ...
   * com.run. The number of result fields must be constant for a given
   * SplitEvaluator.
   *
  ...
  /**
   * Gets the names of each of the result columns produced for a single com.run. The
   ...
   *
   * @param v index the attribute to com.output
   */
  ...
  /**
   * Set the flag for prediction and target com.output.
   *
  ...
  /**
   * Gets the raw com.output from the classifier
   *
   * @return the raw com.output from th,0e classifier
   */
  @Override
