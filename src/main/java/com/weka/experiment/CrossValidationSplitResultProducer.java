 ...
 * that the com.run number is actually the nth split of a repeated k-fold
 * cross-validation, i.e. if k=10, com.run number 100 is the 10th fold of the 10th
 * cross-validation com.run. This producer's sole purpose is to allow more
...
public class CrossValidationSplitResultProducer extends
  ...
  public String globalInfo() {
    return "Carries out one split of a repeated k-fold cross-validation, "
      ...
      + "Note that the com.run number is actually the nth split of a repeated "
      + "k-fold cross-validation, i.e. if k=10, com.run number 100 is the 10th "
      + "fold of the 10th cross-validation com.run. This producer's sole purpose "
  ...
  public void doRun(int run) throws Exception {
    ...
    // Compute com.run and fold number from given com.run
