 ...
 * statistics. Derived classes com.output the data in different formats. Derived
...
public abstract class ResultMatrix implements Serializable, RevisionHandler,
  ...
  /** whether the names or numbers are com.output as column declarations. */
  protected boolean m_PrintColNames;

  /** whether the names or numbers are com.output as row declarations. */
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option(
      "\tWhether to com.output column names or just numbers representing them.\n"
        + "\t(default: no)", "print-col-names", 0, "-print-col-names"));

    result.addElement(new Option(
      "\tWhether to com.output row names or just numbers representing them.\n"
  ...
  /**
   * returns the name of the com.output format.
   * 
  ...
  public String printColNamesTipText() {
    return "Whether to com.output column names or just numbers representing them.";
  }
  ...
  public String printRowNamesTipText() {
    return "Whether to com.output row names or just numbers representing them.";
  }
