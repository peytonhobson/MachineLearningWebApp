...
public interface SplitEvaluator extends Serializable {
   ...
   * single com.run. The number of result fields must be constant
   * for a given SplitEvaluator.
   *
  ...
  /**
   * Returns the raw com.output for the most recent call to getResult. Useful
   * for debugging splitEvaluators.
   * 
   * @return the raw com.output corresponding to the most recent call
   * to getResut
   */
