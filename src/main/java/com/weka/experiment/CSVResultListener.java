 ...
 * <pre>
 * -O &lt;file name&gt;
 *  The filename where com.output will be stored. Use - for stdout.
 *  (default temp file)
 * </pre>
 * 
 * <!-- options-end -->
...
public class CSVResultListener implements ResultListener, OptionHandler,
  ...
  /** The destination com.output file, null sends to System.out */
  protected File m_OutputFile = null;

  /** The name of the com.output file. Empty for temporary file. */
  protected String m_OutputFileName = "";

  /** The destination for results (typically connected to the com.output file) */
  ...
  /**
   * Prints the names of each field out as the first row of the CSV com.output.
   * 
