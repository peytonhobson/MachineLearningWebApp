 ...
 * com.run for varying sized subsamples of the dataset. Normally used with an
 ...
 * 
 * <pre>
 * Options specific to result producer com.weka.experiment.AveragingResultProducer:
 * </pre>
 * 
 * <pre>
 * -F &lt;field name&gt;
...
public class LearningRateResultProducer implements ResultListener,
  ...
  public String globalInfo() {
    return "Tells a sub-ResultProducer to reproduce the current com.run for "
