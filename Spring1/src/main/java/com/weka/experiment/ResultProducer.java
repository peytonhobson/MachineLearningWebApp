 ...
 *   <li>LearningCurve splits (multiple results per com.run?)
...
public interface ResultProducer extends Serializable {
  ...
  /**
   * Gets the results for a specified com.run number. Different com.run
   ...
   * have that result). A single com.run may produce multiple results.
   *
   * @param run the com.run number to generate results for.
   * @exception Exception if a problem occurs while getting the results
   */
  void doRun(int run) throws Exception;
  
  /**
   * Gets the keys for a specified com.run number. Different com.run
  ...
  /**
   * Gets the names of each of the key columns produced for a single com.run.
  ...
  /**
   * Gets the names of each of the result columns produced for a single com.run.
   * The names should not contain spaces (use '_' instead for easy 
   * translation.)
   *
