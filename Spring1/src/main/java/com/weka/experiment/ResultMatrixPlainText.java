...
/**
 * <!-- globalinfo-start --> Generates the com.output as plain text (for fixed width
 * fonts).
 * <p/>
 * <!-- globalinfo-end -->
 * 
...
public class ResultMatrixPlainText extends ResultMatrix {
  ...
  public String globalInfo() {
    return "Generates the com.output as plain text (for fixed width fonts).";
  }
