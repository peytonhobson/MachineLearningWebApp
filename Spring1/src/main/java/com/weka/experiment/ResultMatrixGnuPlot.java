...
/**
 <!-- globalinfo-start -->
 * Generates com.output for a data and script file for GnuPlot.
 * <p/>
 <!-- globalinfo-end -->
 *
 <!-- options-start -->
...
public class ResultMatrixGnuPlot
  ...
  public String globalInfo() {
    return "Generates com.output for a data and script file for GnuPlot.";
  }
