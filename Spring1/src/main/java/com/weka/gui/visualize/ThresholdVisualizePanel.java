...
import com.weka.classifiers.evaluation.EvaluationUtils;
...
public class ThresholdVisualizePanel extends VisualizePanel {
   ...
   * 
   * -W classname <br/>
   * Full classname of classifier to com.run.<br/>
    ...
    try {
      ...
      if (compute) {
        ...
        if (tmpStr.length() != 0) {
          ...
          tmpStr = com.weka.classifiers.functions.Logistic.class.getName();
