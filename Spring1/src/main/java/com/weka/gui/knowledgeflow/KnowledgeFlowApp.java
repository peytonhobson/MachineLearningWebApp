...
public class KnowledgeFlowApp extends AbstractGUIApplication {
  ...
  public KnowledgeFlowApp(boolean layoutComponent) {
    super(layoutComponent, "com.weka.gui.knowledgeflow", "com.weka.gui.SimpleCLIPanel");
