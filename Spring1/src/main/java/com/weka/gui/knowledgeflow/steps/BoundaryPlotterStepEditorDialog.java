...
import com.weka.knowledgeflow.steps.BoundaryPlotter;
...
public class BoundaryPlotterStepEditorDialog extends GOEStepEditorDialog {
   ...
   * instances structure at design time
   */
  protected com.weka.gui.EnvironmentField m_xEnviro =
    new com.weka.gui.EnvironmentField();

  /**
   * Environment field for specifying the y attribute when there isn't incoming
   * instances structure at design time
   */
  protected com.weka.gui.EnvironmentField m_yEnviro =
    new com.weka.gui.EnvironmentField();
