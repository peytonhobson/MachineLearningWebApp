...
/**
 * A dialog for setting various com.output format parameters.
 * 
...
public class OutputFormatDialog extends JDialog {
  ...
  /**
   * Sets the matrix to use as initial selected com.output format.
   * 
   * @param matrix the matrix to use as initial selected com.output format
   */
  ...
  /**
   * Gets the currently selected com.output format result matrix.
   * 
   * @return the currently selected matrix to use as com.output
   */
