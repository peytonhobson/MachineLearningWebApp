...
public class InstanceJoiner implements Serializable, InstanceProducer,
  ...
  /** The current com.output instance */
   ...
   * default implementation assumes the com.output format is determined when
   ...
   * @throws Exception if no input structure has been defined (or the com.output
  ...
  public Instances outputFormat() throws Exception {
    ...
    if (m_InputFormat == null) {
      throw new Exception("No com.output format defined.");
    }
  ...
  public Instance outputPeek() throws Exception {
    ...
    if (m_InputFormat == null) {
      throw new Exception("No com.output instance format defined");
    }
    ...
    if (listeners.size() > 0) {
      ...
      try {
        ...
        System.err.println("Problem: notifyInstanceProduced() was\n"
          + "called with INSTANCE_AVAILABLE, but com.output()\n"
