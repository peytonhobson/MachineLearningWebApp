 ...
 * @deprecated Use {@code com.weka.gui.InteractiveTableModel} instead. Retained for
 * backward compatibility
 */
@Deprecated
public class InteractiveTableModel extends com.weka.gui.InteractiveTableModel {
