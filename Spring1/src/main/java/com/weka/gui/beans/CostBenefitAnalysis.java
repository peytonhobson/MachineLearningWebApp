...
public class CostBenefitAnalysis extends JPanel implements BeanCommon,
  ...
  public static void main(String[] args) {
    try {
      ...
      com.weka.classifiers.evaluation.ThresholdCurve tc = new com.weka.classifiers.evaluation.ThresholdCurve();
      com.weka.classifiers.evaluation.EvaluationUtils eu = new com.weka.classifiers.evaluation.EvaluationUtils();
      // com.weka.classifiers.Classifier classifier = new
      // com.weka.classifiers.functions.Logistic();
      com.weka.classifiers.Classifier classifier = new com.weka.classifiers.bayes.NaiveBayes();
