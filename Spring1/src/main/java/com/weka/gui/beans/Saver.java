...
import com.weka.core.converters.ArffSaver;
import com.weka.core.converters.DatabaseConverter;
import com.weka.core.converters.DatabaseSaver;

/**
 * Saves data sets using com.weka.core.converter classes
 * 
...
public class Saver extends AbstractDataSink implements WekaWrapper,
   ...
   * Saver
   */
  private com.weka.core.converters.Saver m_Saver = new ArffSaver();
  private com.weka.core.converters.Saver m_SaverTemplate = m_Saver;
  ...
  private com.weka.core.converters.Saver makeCopy() throws Exception {
    return (com.weka.core.converters.Saver) new SerializedObject(m_SaverTemplate)
      .getObject();
  }
   ...
   * @param saver a Saver
   */
  public void setSaverTemplate(com.weka.core.converters.Saver saver) {
  ...
  protected String sanitizeFilename(String filename) {
    ...
    filename = Utils.removeSubstring(filename,
      "com.weka.filters.supervised.instance.");
    filename = Utils.removeSubstring(filename,
      "com.weka.filters.supervised.attribute.");
    filename = Utils.removeSubstring(filename,
      "com.weka.filters.unsupervised.instance.");
    filename = Utils.removeSubstring(filename,
      "com.weka.filters.unsupervised.attribute.");
   ...
   * Get the saver
   * 
   * @return a <code>com.weka.core.converters.Saver</code> value
   */
  public com.weka.core.converters.Saver getSaverTemplate() {
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    if (!(algorithm instanceof com.weka.core.converters.Saver)) {
      throw new IllegalArgumentException(algorithm.getClass() + " : incorrect "
        + "type of algorithm (Loader)");
    }
    setSaverTemplate((com.weka.core.converters.Saver) algorithm);
  }
