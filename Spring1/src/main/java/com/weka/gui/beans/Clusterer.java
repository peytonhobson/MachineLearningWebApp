...
/**
 * Bean that wraps around com.weka.clusterers
 * 
...
public class Clusterer extends JPanel implements BeanCommon, Visible,
  ...
  private com.weka.clusterers.Clusterer m_Clusterer = new EM();
   ...
   * 
   * @param c a <code>com.weka.clusterers.Clusterer</code> value
   */
  public void setClusterer(com.weka.clusterers.Clusterer c) {
   ...
   * 
   * @return a <code>com.weka.clusterers.Clusterer</code> value
   */
  ...
  public void setWrappedAlgorithm(Object algorithm) {
    ...
    if (!(algorithm instanceof com.weka.clusterers.Clusterer)) {
      throw new IllegalArgumentException(algorithm.getClass() + " : incorrect "
        + "type of algorithm (Clusterer)");
    }
    setClusterer((com.weka.clusterers.Clusterer) algorithm);
  }
            ...
            public void run() {
              try {
                if (m_trainingSet != null) {
                  ...
                  if (m_Clusterer instanceof com.weka.core.Drawable
                    && m_graphListeners.size() > 0) {
                    String grphString = ((com.weka.core.Drawable) m_Clusterer)
                      .graph();
                    int grphType = ((com.weka.core.Drawable) m_Clusterer)
                      .graphType();
  ...
  public void loadModel() {
    try {
      ...
      if (returnVal == JFileChooser.APPROVE_OPTION) {
        ...
        com.weka.clusterers.Clusterer temp = (com.weka.clusterers.Clusterer) is
          .readObject();
