 ...
 * @version $Revision$
 * @deprecated Use {@code com.weka.gui.InteractiveTablePanel} instead. Retained for
 * backward compatibility
 */
@Deprecated
public class InteractiveTablePanel extends com.weka.gui.InteractiveTablePanel {
