...
import com.weka.classifiers.evaluation.NumericPrediction;
...
import com.weka.gui.visualize.Plot2D;
...
public class ClassifierErrorsPlotInstances extends AbstractPlotInstances {
  ...
  /**
   * Get the vector of plot shapes (see com.weka.gui.visualize.Plot2D).
   * 
  ...
  /**
   * Get the vector of plot sizes (see com.weka.gui.visualize.Plot2D).
   * 
  ...
  public void process(Instance toPredict, Classifier classifier, Evaluation eval) {
    ...
    try {
      ...
      if (classifier instanceof com.weka.classifiers.misc.InputMappedClassifier
        ...
        toPredict = ((com.weka.classifiers.misc.InputMappedClassifier) classifier)
          .constructMappedInstance(toPredict);
        mappedClass = ((com.weka.classifiers.misc.InputMappedClassifier) classifier)
          .getMappedClassIndex();
