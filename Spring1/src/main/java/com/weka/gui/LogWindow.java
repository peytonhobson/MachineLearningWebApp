...
/**
 * Frame that shows the com.output from stdout and stderr.
 * 
...
public class LogWindow extends JFrame implements CaretListener, ChangeListener {
  ...
  /** whether we're debugging - enables com.output on stdout */
  ...
  protected class LogWindowPrintStream extends PrintStream {
     ...
     * @param style the style name associated with this com.output
     */
