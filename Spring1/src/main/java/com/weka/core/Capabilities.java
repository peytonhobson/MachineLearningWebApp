...
public class Capabilities implements Cloneable, Serializable, RevisionHandler {
  ...
  public Capabilities(CapabilitiesHandler owner) {
    ...
    if (owner instanceof com.weka.classifiers.UpdateableClassifier
      || owner instanceof com.weka.clusterers.UpdateableClusterer) {
  ...
  public boolean test(Instances data, int fromIndex, int toIndex) {
    ...
    // attributes
    Class weightedAttributesHandler = getClass("com.weka.core.WeightedAttributesHandler");
    ...
    missing = false;
    Class weightedInstancesHandler = getClass("com.weka.core.WeightedInstancesHandler");
    for (i = 0; i < data.numInstances(); i++) {
