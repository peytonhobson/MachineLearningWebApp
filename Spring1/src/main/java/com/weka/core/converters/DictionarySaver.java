...
import com.weka.core.DictionaryBuilder;
...
public class DictionarySaver extends AbstractFileSaver implements
        ...
        if (retrieveFile() == null && getWriter() == null) {
          if (getSaveBinaryDictionary()) {
            throw new IOException(
              "Can't com.output binary dictionary to standard out!");
          }
  ...
  public void writeBatch() throws IOException {
    ...
    if (retrieveFile() == null && getWriter() == null) {
      if (getSaveBinaryDictionary()) {
        throw new IOException("Can't com.output binary dictionary to standard out!");
      }
