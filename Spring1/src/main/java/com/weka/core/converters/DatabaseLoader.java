...
import com.weka.gui.PasswordProperty;
 ...
 * used for ordering but will not be part of the com.output. The user defined SQL
...
public class DatabaseLoader extends AbstractLoader implements BatchConverter,
  ...
  public String globalInfo() {
    return "Reads Instances from a Database. "
      ...
      + "be used for ordering but will not be part of the com.output. The user defined SQL query to extract the instances should not contain LIMIT and ORDER BY clauses (see -Q option).\n"
