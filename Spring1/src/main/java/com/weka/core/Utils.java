...
public final class Utils implements RevisionHandler {
   ...
   *          e.g.: "com.weka/core/Utils.props". (The use of hardcoded forward
   ...
   * @param length the desired length of the com.output string
   * @return the com.output string
   */
   ...
   *          com.weka.gui.GUICHooser.HowToFindPackageManager).
