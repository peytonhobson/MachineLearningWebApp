...
import com.weka.core.neighboursearch.kdtrees.KDTreeNode;
import com.weka.core.neighboursearch.kdtrees.KDTreeNodeSplitter;
import com.weka.core.neighboursearch.kdtrees.SlidingMidPointOfWidestSide;
 ...
 * **PLEASE NOTE:** The algorithm can not handle missing values, so it is advisable to com.run ReplaceMissingValues filter if there are any missing values in the dataset.<br/>
 * <br/>
 ...
 *  (default: com.weka.core.neighboursearch.kdtrees.SlidingMidPointOfWidestSide)</pre>
 * 
 * <pre> -W &lt;value&gt;
...
public class KDTree
   ...
   * is adviseable to com.run the replace missing attributes filter
        ...
        if (ins.index(j) != ins.classIndex())
          if (ins.isMissingSparse(j)) {
            throw new Exception("ERROR: KDTree can not deal with missing "
                + "values. Please com.run ReplaceMissingValues filter "
  ...
  public void assignSubToCenters(KDTreeNode node, Instances centers,
    ...
    // WARNING: assignments is "input/com.output-parameter"
  ...
  public String globalInfo() {
    return 
      ...
      + "is advisable to com.run ReplaceMissingValues filter if there are any "
  ...
  public Enumeration<Option> listOptions() {
	...
	"\tNode splitting method to use.\n"
	+ "\t(default: com.weka.core.neighboursearch.kdtrees.SlidingMidPointOfWidestSide)",
