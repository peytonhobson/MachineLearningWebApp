...
public class XMLDocument
  ...
  /**
   * sets the DOCTYPE-String to use in the XML com.output. Performs NO checking!
   * if it is <code>null</code> the DOCTYPE is omitted. 
   *  
   * @param docType 	the DOCTYPE definition to use in XML com.output
   */
  ...
  /**
   * sets the root node to use in the XML com.output. Performs NO checking with
   * DOCTYPE!
   *  
   * @param rootNode 	the root node to use in the XML com.output
   */
   ...
   * 
   * @param xpath	the XPath expression to com.run on the document
