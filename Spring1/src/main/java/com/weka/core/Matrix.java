 ...
 * <code>com.weka.core.matrix</code> - only for backwards compatibility.
 * 
 ...
 * @version $Revision$
 * @deprecated Use <code>com.weka.core.matrix.Matrix</code> instead - only for
...
public class Matrix implements Cloneable, Serializable, RevisionHandler {
   ...
   * The actual matrix
   */
  protected com.weka.core.matrix.Matrix m_Matrix = null;
  ...
  public Matrix(int nr, int nc) {
    m_Matrix = new com.weka.core.matrix.Matrix(nr, nc);
  }
  ...
  public Matrix(double[][] array) throws Exception {
    m_Matrix = new com.weka.core.matrix.Matrix(array);
  }
  ...
  public Matrix(Reader r) throws Exception {
    m_Matrix = new com.weka.core.matrix.Matrix(r);
  }
   ...
   * @see #m_Matrix
   */
  protected com.weka.core.matrix.Matrix getMatrix() {
    return m_Matrix;
  }
  ...
  public int[] LUDecomposition() throws Exception {
    // decompose
    com.weka.core.matrix.LUDecomposition lu = m_Matrix.lu();
    ...
    com.weka.core.matrix.Matrix u = lu.getU();
    com.weka.core.matrix.Matrix l = lu.getL();
  ...
  public void solve(double[] bb) throws Exception {
    // solve
    com.weka.core.matrix.Matrix x = m_Matrix.solve(new com.weka.core.matrix.Matrix(bb,
      bb.length));
  ...
  public void eigenvalueDecomposition(double[][] V, double[] d)
    ...
    com.weka.core.matrix.EigenvalueDecomposition eig = m_Matrix.eig();
    com.weka.core.matrix.Matrix v = eig.getV();
  ...
  protected static double hypot(double a, double b) {
    return com.weka.core.matrix.Maths.hypot(a, b);
  }
  ...
  public static Matrix parseMatlab(String matlab) throws Exception {
    return new Matrix(com.weka.core.matrix.Matrix.parseMatlab(matlab).getArray());
  }
