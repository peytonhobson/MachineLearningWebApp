...
public abstract class Check implements OptionHandler, RevisionHandler {
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option("\tTurn on debugging com.output.", "D", 0, "-D"));
   ...
   * specify a classname prefix (e.g., "com.weka.classifiers") to avoid long
   ...
   * 
   * @param check the checkscheme to setup and com.run
