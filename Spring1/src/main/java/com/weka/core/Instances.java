...
import com.weka.core.converters.ArffLoader.ArffReader;
...
RevisionHandler {
   ...
   *             instead.
   * @see com.weka.core.converters.ArffLoader
   * @see com.weka.core.converters.ConverterUtils.DataSource
   */
  // @ requires capacity >= 0;
  ...
  public AttributeStats attributeStats(int index) {
    ...
    if (attribute(index).isNumeric()) {
      result.numericStats = new com.weka.experiment.Stats();
    }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // wrong parameters or help
        ...
        .println("\nUsage:\n"
          // help
          + "\tcom.weka.core.Instances help\n"
          + "\t\tPrints this help\n"
          // stats
          + "\tcom.weka.core.Instances <filename>\n"
          + "\t\tOutputs dataset statistics\n"
          // merge
          + "\tcom.weka.core.Instances merge <filename1> <filename2>\n"
          + "\t\tMerges the datasets (must have same number of rows).\n"
          + "\t\tGenerated dataset gets com.output on stdout.\n"
          // append
          + "\tcom.weka.core.Instances append <filename1> <filename2>\n"
          + "\t\tAppends the second dataset to the first (must have same number of attributes).\n"
          + "\t\tGenerated dataset gets com.output on stdout.\n"
          // headers
          + "\tcom.weka.core.Instances headers <filename1> <filename2>\n"
          + "\t\tCompares the structure of the two datasets and outputs whether they\n"
          + "\t\tdiffer or not.\n"
          // randomize
          + "\tcom.weka.core.Instances randomize <seed> <filename>\n"
