...
public class AssociatorEvaluation implements RevisionHandler {
  ...
  /**
   * Generates an option string to com.output on the commandline.
   * 
   ...
   * @return the generated com.output string
  ...
  public static String evaluate(Associator associator, String[] options)
    ...
    // If associator is drawable com.output string describing graph
   ...
   * 
   * @param associator the Associator to evaluate
   * @param data the data to com.run the associator with
   * @return the generated com.output string
   * @throws Exception if evaluation fails
   */
