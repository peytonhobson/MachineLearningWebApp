 ...
 * @version $Revision$
 * @see com.weka.core.UnsupportedAttributeTypeException
 */
public class CostMatrix implements Serializable, RevisionHandler {
   ...
   * matrix. (FracPete: taken from old com.weka.core.Matrix class)
   * 
   ...
   * constructor. (FracPete: taken from old com.weka.core.Matrix class)
   * 
   * @param w the com.output Writer
   * @throws Exception if an error occurs
   */
  ...
  /**
   * Converts a matrix to a string. (FracPete: taken from old com.weka.core.Matrix
   * class)
   * 
