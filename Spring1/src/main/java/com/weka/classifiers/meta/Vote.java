...
import com.weka.classifiers.RandomizableMultipleClassifiersCombiner;
 ...
 * <pre>
 * -print
 *  Print the individual models in the com.output
 * </pre>
 * 
 * <pre>
 * -S &lt;num&gt;
...
public class Vote extends RandomizableMultipleClassifiersCombiner implements
  ...
  public Enumeration<Option> listOptions() {
    ...
    result.addElement(new Option(
      "\tSuppress the printing of the individual models in the com.output",
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (m_classifiersToLoad.size() > 0) {
      ...
      if (m_Classifiers.length == 1
        && m_Classifiers[0] instanceof com.weka.classifiers.rules.ZeroR) {
  ...
  public String doNotPrintModelsTipText() {
    return "Do not print the individual trees in the com.output";
  }

  /**
   * Set whether to print the individual ensemble models in the com.output
   * 
  ...
  /**
   * Get whether to print the individual ensemble models in the com.output
   * 
