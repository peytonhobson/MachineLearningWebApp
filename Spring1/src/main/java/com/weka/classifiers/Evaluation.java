...
package com.weka.classifiers;

import com.weka.classifiers.evaluation.AbstractEvaluationMetric;
...
import com.weka.core.Summarizable;
 ...
 * implementation in com.weka.classifiers.evaluation.Evaluation.
 * 
 * <p/>
 * 
 * -------------------------------------------------------------------
...
public class Evaluation implements Serializable, Summarizable, RevisionHandler {
  ...
  public static final String[] BUILT_IN_EVAL_METRICS = com.weka.classifiers.evaluation.Evaluation.BUILT_IN_EVAL_METRICS;

  /** The actual evaluation object that we delegate to */
  protected com.weka.classifiers.evaluation.Evaluation m_delegate;
  ...
  public static List<String> getAllEvaluationMetricNames() {
    return com.weka.classifiers.evaluation.Evaluation.getAllEvaluationMetricNames();
  }

  public Evaluation(Instances data) throws Exception {
    m_delegate = new com.weka.classifiers.evaluation.Evaluation(data);
  }

  public Evaluation(Instances data, CostMatrix costMatrix) throws Exception {
    m_delegate = new com.weka.classifiers.evaluation.Evaluation(data, costMatrix);
  }
  ...
  public static String evaluateModel(String classifierString, String[] options)
    ...
    return com.weka.classifiers.evaluation.Evaluation.evaluateModel(
  ...
  public static String evaluateModel(Classifier classifier, String[] options)
    throws Exception {
    return com.weka.classifiers.evaluation.Evaluation.evaluateModel(classifier,
      options);
  }
  ...
  public static String wekaStaticWrapper(Sourcable classifier, String className)
    throws Exception {
    return com.weka.classifiers.evaluation.Evaluation.wekaStaticWrapper(classifier,
      className);
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof com.weka.classifiers.Evaluation) {
      obj = ((com.weka.classifiers.Evaluation) obj).m_delegate;
    }
