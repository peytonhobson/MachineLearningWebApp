 ...
 * in com.weka.classifiers.evaluation.AggregateableEvaluation.
 * 
...
public class AggregateableEvaluation extends Evaluation {
  ...
  public AggregateableEvaluation(Instances data) throws Exception {
    super(data);
    m_delegate = new com.weka.classifiers.evaluation.AggregateableEvaluation(data);
  }
  ...
  public AggregateableEvaluation(Evaluation eval) throws Exception {
    ...
    m_delegate = new com.weka.classifiers.evaluation.AggregateableEvaluation(
        eval.m_delegate);
  }
  ...
  public void aggregate(Evaluation evaluation) {
    ((com.weka.classifiers.evaluation.AggregateableEvaluation) m_delegate)
