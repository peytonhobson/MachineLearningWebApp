...
public class DataGenerator extends WekaAlgorithmWrapper {
  ...
  public Class getWrappedAlgorithmClass() {
    return com.weka.datagenerators.DataGenerator.class;
  }
   ...
   */
  public com.weka.datagenerators.DataGenerator getDataGenerator() {
    return (com.weka.datagenerators.DataGenerator) getWrappedAlgorithm();
  }
  ...
  public void setDataGenerator(com.weka.datagenerators.DataGenerator dataGenerator) {
  ...
  public void start() throws WekaException {
    if (getStepManager().numOutgoingConnections() > 0) {
      com.weka.datagenerators.DataGenerator generator = getDataGenerator();
      if (getStepManager()
