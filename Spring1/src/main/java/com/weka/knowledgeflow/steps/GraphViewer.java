...
/**
 * Step for collecting and visualizing graph com.output from Drawable schemes.
 *
 * @author Mark Hall (mhall{[at]}pentaho{[dot]}com)
 * @version $Revision: $
 */
@KFStep(name = "GraphViewer", category = "Visualization",
  toolTipText = "Visualize graph com.output from Drawable schemes",
  ...
  public Map<String, String> getInteractiveViewers() {
    ...
    if (m_data.size() > 0) {
      views.put("Show plots",
        "com.weka.gui.knowledgeflow.steps.GraphViewerInteractiveView");
    }
