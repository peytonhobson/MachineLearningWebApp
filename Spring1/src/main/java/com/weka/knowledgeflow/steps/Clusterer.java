...
public class Clusterer extends WekaAlgorithmWrapper implements
  PairedDataHelper.PairedProcessor<com.weka.clusterers.Clusterer> {
   ...
   */
  protected com.weka.clusterers.Clusterer m_clustererTemplate;

  /** Holds a trained/loaded clusterer */
  protected com.weka.clusterers.Clusterer m_trainedClusterer;
  ...
  protected transient PairedDataHelper<com.weka.clusterers.Clusterer> m_trainTestHelper;
  ...
  /** Re-usable Data object for incrementalClusterer com.output */
   ...
   */
  public com.weka.clusterers.Clusterer getClusterer() {
    return (com.weka.clusterers.Clusterer) getWrappedAlgorithm();
  }
  ...
  public void setClusterer(com.weka.clusterers.Clusterer clusterer) {
  ...
  public Class getWrappedAlgorithmClass() {
    return com.weka.clusterers.Clusterer.class;
  }
  ...
  public void stepInit() throws WekaException {
    if (!(getWrappedAlgorithm() instanceof com.weka.clusterers.Clusterer)) {
      throw new WekaException("Incorrect type of algorithm");
    }

    try {
      m_clustererTemplate =
        com.weka.clusterers.AbstractClusterer
          .makeCopy((com.weka.clusterers.Clusterer) getWrappedAlgorithm());
    ...
    if (getStepManager().numIncomingConnectionsOfType(
      ...
      m_trainTestHelper =
        new PairedDataHelper<com.weka.clusterers.Clusterer>(
          this,
          this,
      ...
      if (m_isReset) {
        ...
        if (data.getConnectionName().equals(StepManager.CON_INSTANCE)) {
          ...
          if (m_trainedClusterer == null) {
            m_trainedClusterer =
              com.weka.clusterers.AbstractClusterer.makeCopy(m_clustererTemplate);
  ...
  protected void processOnlyTestSet(Data data) throws WekaException {
    try {
      com.weka.clusterers.Clusterer tempToTest =
        com.weka.clusterers.AbstractClusterer.makeCopy(m_trainedClusterer);
      Data batchClusterer =
  ...
  protected void loadModel(String filePath) throws Exception {
    ...
    try {
      ...
      m_trainedClusterer = (com.weka.clusterers.Clusterer) is.readObject();
   ...
   */
  protected void
    outputGraphData(com.weka.clusterers.Clusterer clusterer, int setNum)
   ...
   */
  protected void
    outputTextData(com.weka.clusterers.Clusterer clusterer, int setNum)
      throws WekaException {
   ...
   * @throws WekaException if a problem occurs
   */
  protected void outputBatchClusterer(com.weka.clusterers.Clusterer clusterer,
   ...
   */
  @Override
  public com.weka.clusterers.Clusterer processPrimary(Integer setNum,
                                                      Integer maxSetNum, Data data,
                                                      PairedDataHelper<com.weka.clusterers.Clusterer> helper) throws WekaException {
    Instances trainingData = data.getPrimaryPayload();
    try {
      com.weka.clusterers.Clusterer clusterer =
        com.weka.clusterers.AbstractClusterer.makeCopy(m_clustererTemplate);
      ...
      if (!isStopRequested()) {
        ...
        if (getStepManager().numIncomingConnectionsOfType(
          ...
          // com.output a butch clusterer for just the trained model
