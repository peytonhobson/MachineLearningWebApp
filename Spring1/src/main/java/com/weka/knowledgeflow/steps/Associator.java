...
import com.weka.associations.AssociationRulesProducer;
...
public class Associator extends WekaAlgorithmWrapper {
  ...
  protected com.weka.associations.Associator m_associatorTemplate;
  ...
  public Class getWrappedAlgorithmClass() {
    return com.weka.associations.Associator.class;
  }
  ...
  public void setAssociator(com.weka.associations.Associator associator) {
   ...
   */
  public com.weka.associations.Associator getAssociator() {
    return (com.weka.associations.Associator) getWrappedAlgorithm();
  }
  ...
  public void stepInit() throws WekaException {
    if (!(getWrappedAlgorithm() instanceof com.weka.associations.Associator)) {
      throw new WekaException("Wrapped algorithm is not an instance of "
        + "a com.weka.associations.Associator!");
    }

    try {
      m_associatorTemplate =
        com.weka.associations.AbstractAssociator.makeCopy(getAssociator());
    } catch (Exception ex) {
  ...
  public void processIncoming(Data data) throws WekaException {
    ...
    try {
      if (!isStopRequested()) {
        ...
        com.weka.associations.Associator associator =
          com.weka.associations.AbstractAssociator.makeCopy(m_associatorTemplate);
   ...
   *
   * @param associator the associator to com.output
   * @param setNum the set number of the data used to train the associator
   * @param maxSetNum the maximum set number
   * @throws WekaException if a problem occurs
   */
  protected void outputAssociatorData(com.weka.associations.Associator associator,
   ...
   * 
   * @param associator the associator to com.output the textual form for
   * @param train the training data used to train the associator
   * @param setNum the set number of the data
   * @throws WekaException if a problem occurs
   */
  protected void outputTextData(com.weka.associations.Associator associator,
  ...
  protected void outputGraphData(com.weka.associations.Associator associator,
   ...
   * 
   * @param connectionName the connection type to generate com.output structure for
   * @return the com.output structure this step generates, or null if it can't be
