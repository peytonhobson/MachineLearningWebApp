...
import com.weka.core.EnumHelper;
...
public class JSONFlowUtils {
  ...
  /**
   * Add a {@code com.weka.core.converters.Saver} to the JSON
   * 
  ...
  protected static void addSaver(String propName,
                                 com.weka.core.converters.Saver saver, JSONNode json) {
    ...
    if (saver instanceof com.weka.core.converters.FileSourcedConverter) {
      relativeB =
        ((com.weka.core.converters.FileSourcedConverter) saver)
          .getUseRelativePath();
    }
  ...
  /**
   * Add a {@code com.weka.core.converters.Loader} to the JSON
   *
  ...
  protected static void addLoader(String propName,
                                  com.weka.core.converters.Loader loader, JSONNode json) {
    ...
    if (loader instanceof com.weka.core.converters.FileSourcedConverter) {
      relativeB =
        ((com.weka.core.converters.FileSourcedConverter) loader)
          .getUseRelativePath();
    }
    ...
    if (file != null && !file.isDirectory()) {
      ...
      boolean notAbsolute =
        (((com.weka.core.converters.AbstractFileLoader) loader)
          .getUseRelativePath()
  ...
  protected static void addStepJSONtoFlowArray(JSONNode stepArray,
    ...
    try {
      ...
      for (PropertyDescriptor p : stepProps) {
        ...
        } else if (propValue instanceof com.weka.core.converters.Loader) {
          addLoader(name, (com.weka.core.converters.Loader) propValue, properties);
        } else if (propValue instanceof com.weka.core.converters.Saver) {
          addSaver(name, (com.weka.core.converters.Saver) propValue, properties);
  ...
  /**
   * Read a {@code com.weka.core.converters.Loader} from the current JSON node
   *
   * @param loaderNode the {@code JSONNode} to read the loader from
   * @return the instantiated loader
   * @throws WekaException if a problem occurs
   */
  protected static com.weka.core.converters.Loader readStepPropertyLoader(
    ...
    try {
      com.weka.core.converters.Loader loader =
        (com.weka.core.converters.Loader) WekaPackageClassLoaderManager
          .objectForName(clazz);
      /*
  ...
  /**
   * Read a {@code com.weka.core.converters.Saver} from the current JSON node
   *
   * @param saverNode the {@code JSONNode} to read from
   * @return an instantiated saver
   * @throws WekaException if a problem occurs
   */
  protected static com.weka.core.converters.Saver readStepPropertySaver(
    ...
    try {
      com.weka.core.converters.Saver saver =
        (com.weka.core.converters.Saver) WekaPackageClassLoaderManager
          .objectForName(clazz);
      /*
       * Beans.instantiate( JSONFlowUtils.class.getClassLoader(), clazz);
       */
      ...
      if (saver instanceof com.weka.core.converters.AbstractFileSaver) {
        ...
        if (dir != null && prefix != null) {
          ((com.weka.core.converters.AbstractFileSaver) saver).setDir(dir);
          ((com.weka.core.converters.AbstractFileSaver) saver)
  ...
  public static void main(String[] args) {
    try {
      com.weka.knowledgeflow.steps.Loader step =
        new com.weka.knowledgeflow.steps.Loader();
      com.weka.core.converters.ArffLoader arffL =
        new com.weka.core.converters.ArffLoader();
      ...
      com.weka.core.converters.CSVSaver arffS = new com.weka.core.converters.CSVSaver();
      arffS.setDir(".");
      arffS.setFilePrefix("");
