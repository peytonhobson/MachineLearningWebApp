...
import com.weka.core.ThreadSafe;
...
public class CfsSubsetEval extends ASEvaluation implements SubsetEvaluator,
  ...
  /**
   * Set whether to com.output debugging info
   * 
   * @param d true if debugging info is to be com.output
   */
   ...
   * Set whether to com.output debugging info
   * 
   * @return true if debugging info is to be com.output
   */
