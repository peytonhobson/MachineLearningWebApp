 ...
 * 
 * <pre> -D
 *  Turns on com.output of debugging information.</pre>
 * 
 <!-- options-end -->
 *
...
public class RemoveDuplicates extends SimpleBatchFilter implements WeightedAttributesHandler, WeightedInstancesHandler{
  ...
  /**
   * Determines the com.output format based on the input format and returns
   * this.
   *
  ...
  /**
   * returns true if the com.output format is immediately available after the
