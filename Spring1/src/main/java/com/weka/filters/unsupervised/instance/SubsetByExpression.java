...
package com.weka.filters.unsupervised.instance;
...
import com.weka.core.expressionlanguage.common.Primitives.BooleanExpression;
...
public class SubsetByExpression extends SimpleBatchFilter
   ...
   * read before producing com.output (calling the method batchFinished() makes the
  ...
  /**
   * Determines the com.output format based on the input format and returns this.
   * 
