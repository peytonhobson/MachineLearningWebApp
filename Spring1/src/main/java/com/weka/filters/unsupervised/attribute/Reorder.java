...
/**
 * <!-- globalinfo-start --> A filter that generates com.output with a new order of
 ...
 * generate the following com.output order: 1,3,5,7,9,10 or 10,1-5.<br/><br/>
...
public class Reorder extends Filter implements UnsupervisedFilter,
  ...
  /**
   * Whether to set all attribute weights to one in com.output data.
   */
  ...
  public String globalInfo() {
    return "A filter that generates com.output with a new order of the "
      ...
      + "can generate the following com.output order: 1,3,5,7,9,10 or 10,1-5.\n\n"
   ...
   *          <code>setInputFormat(Instances)</code>, since the com.output format is
