 ...
 * <pre>
 * -F &lt;value index&gt;
 *  Sets the com.output date format string (default corresponds to ISO-8601).
 * </pre>
 * 
 * <!-- options-end -->
 * 
...
public class ChangeDateFormat extends Filter implements UnsupervisedFilter,
  ...
  /** The default com.output date format. Corresponds to ISO-8601 format. */
    ...
    if (!newInstance.isMissing(index)) {
      ...
      try {
        ...
        throw new RuntimeException(
          "Output date format couldn't parse its own com.output!!");
      }
  ...
  /**
   * Get the date format used in com.output.
   * 
   * @return the com.output date format.
   */
  ...
  /**
   * Sets the com.output date format.
   * 
   * @param dateFormat the com.output date format.
   */
  ...
  /**
   * Set the com.output format. Changes the format of the specified date attribute.
   */
